...
pub const AMD_DISPLAY_NATIVE_HDR_EXTENSION_NAME: *const std::os::raw::c_char = crate::cstr!(
    "VK_AMD_display_native_hdr"
);
///<s>Vulkan Manual Page</s> · Constant
pub const FN_SET_LOCAL_DIMMING_AMD: *const std::os::raw::c_char = crate::cstr!(
...
impl<'a> crate::ExtendableFrom<'a, DisplayNativeHdrSurfaceCapabilitiesAMD>
for crate::extensions::khr_get_surface_capabilities2::SurfaceCapabilities2KHRBuilder<
    'a,
> {}
impl<'a> crate::ExtendableFrom<'a, DisplayNativeHdrSurfaceCapabilitiesAMDBuilder<'_>>
for crate::extensions::khr_get_surface_capabilities2::SurfaceCapabilities2KHRBuilder<
    'a,
> {}
///Provided by [`crate::extensions::amd_display_native_hdr`]
