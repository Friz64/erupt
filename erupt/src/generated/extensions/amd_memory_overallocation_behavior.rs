...
pub const AMD_MEMORY_OVERALLOCATION_BEHAVIOR_EXTENSION_NAME: *const std::os::raw::c_char = crate::cstr!(
...
impl<'a> crate::ExtendableFrom<'a, DeviceMemoryOverallocationCreateInfoAMD>
