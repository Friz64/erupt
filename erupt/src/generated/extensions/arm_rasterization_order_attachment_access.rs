...
pub const ARM_RASTERIZATION_ORDER_ATTACHMENT_ACCESS_EXTENSION_NAME: *const std::os::raw::c_char = crate::cstr!(
    "VK_ARM_rasterization_order_attachment_access"
);
///Provided by [`crate::extensions::arm_rasterization_order_attachment_access`]
impl crate::vk1_0::StructureType {
    pub const PHYSICAL_DEVICE_RASTERIZATION_ORDER_ATTACHMENT_ACCESS_FEATURES_ARM: Self = Self(
        1000342000,
    );
}
///Provided by [`crate::extensions::arm_rasterization_order_attachment_access`]
...
impl<
    'a,
> crate::ExtendableFrom<'a, PhysicalDeviceRasterizationOrderAttachmentAccessFeaturesARM>
...
impl std::fmt::Debug for PhysicalDeviceRasterizationOrderAttachmentAccessFeaturesARM {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f
            .debug_struct("PhysicalDeviceRasterizationOrderAttachmentAccessFeaturesARM")
            .field("s_type", &self.s_type)
            .field("p_next", &self.p_next)
            .field(
                "rasterization_order_color_attachment_access",
                &(self.rasterization_order_color_attachment_access != 0),
            )
            .field(
                "rasterization_order_depth_attachment_access",
                &(self.rasterization_order_depth_attachment_access != 0),
            )
            .field(
                "rasterization_order_stencil_attachment_access",
                &(self.rasterization_order_stencil_attachment_access != 0),
            )
            .finish()
    }
}
...
impl<'a> PhysicalDeviceRasterizationOrderAttachmentAccessFeaturesARMBuilder<'a> {
    #[inline]
    pub fn new() -> PhysicalDeviceRasterizationOrderAttachmentAccessFeaturesARMBuilder<
            'a,
        > {
        PhysicalDeviceRasterizationOrderAttachmentAccessFeaturesARMBuilder(
            Default::default(),
    ...
    pub fn rasterization_order_color_attachment_access(
        ...
        self
            .0
            .rasterization_order_color_attachment_access = rasterization_order_color_attachment_access
            as _;
        self
    }
    #[inline]
    ...
    pub fn rasterization_order_depth_attachment_access(
        ...
        self
            .0
            .rasterization_order_depth_attachment_access = rasterization_order_depth_attachment_access
            as _;
        self
    }
    #[inline]
    ...
    pub fn rasterization_order_stencil_attachment_access(
        ...
        self
            .0
            .rasterization_order_stencil_attachment_access = rasterization_order_stencil_attachment_access
            as _;
        self
    }
    #[inline]
...
for PhysicalDeviceRasterizationOrderAttachmentAccessFeaturesARMBuilder<'a> {
    fn default() -> PhysicalDeviceRasterizationOrderAttachmentAccessFeaturesARMBuilder<
            'a,
        > {
        Self::new()
    }
