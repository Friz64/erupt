...
pub type PFN_vkAcquireXlibDisplayEXT =
    unsafe extern "system" fn(physical_device: crate::vk1_0::PhysicalDevice, dpy: *mut std::ffi::c_void, display: crate::extensions::khr_display::DisplayKHR) -> crate::vk1_0::Result;
