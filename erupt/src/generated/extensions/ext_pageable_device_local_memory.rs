...
pub const EXT_PAGEABLE_DEVICE_LOCAL_MEMORY_EXTENSION_NAME: *const std::os::raw::c_char = crate::cstr!(
    "VK_EXT_pageable_device_local_memory"
);
///<s>Vulkan Manual Page</s> · Constant
pub const FN_SET_DEVICE_MEMORY_PRIORITY_EXT: *const std::os::raw::c_char = crate::cstr!(
...
impl std::fmt::Debug for PhysicalDevicePageableDeviceLocalMemoryFeaturesEXT {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f
            .debug_struct("PhysicalDevicePageableDeviceLocalMemoryFeaturesEXT")
            .field("s_type", &self.s_type)
            .field("p_next", &self.p_next)
            .field(
                "pageable_device_local_memory",
                &(self.pageable_device_local_memory != 0),
            )
            .finish()
    }
}
