...
pub const EXT_PHYSICAL_DEVICE_DRM_EXTENSION_NAME: *const std::os::raw::c_char = crate::cstr!(
...
impl<'a> crate::ExtendableFrom<'a, PhysicalDeviceDrmPropertiesEXT>
...
impl std::fmt::Debug for PhysicalDeviceDrmPropertiesEXT {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct("PhysicalDeviceDrmPropertiesEXT")
            ...
            .field("has_render", &(self.has_render != 0))
