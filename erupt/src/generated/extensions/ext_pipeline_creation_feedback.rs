...
bitflags::bitflags! {
    #[doc =
    "[Vulkan Manual Page](https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/VkPipelineCreationFeedbackFlagsEXT.html) · Bitmask of [`PipelineCreationFeedbackFlagBitsEXT`]"]
    #[doc(alias = "VkPipelineCreationFeedbackFlagsEXT")] #[derive(Default)]
    #[repr(transparent)] pub struct PipelineCreationFeedbackFlagsEXT : u32 { const
    VALID_EXT = PipelineCreationFeedbackFlagBitsEXT::VALID_EXT.0; const
    APPLICATION_PIPELINE_CACHE_HIT_EXT =
    PipelineCreationFeedbackFlagBitsEXT::APPLICATION_PIPELINE_CACHE_HIT_EXT.0; const
    BASE_PIPELINE_ACCELERATION_EXT =
    PipelineCreationFeedbackFlagBitsEXT::BASE_PIPELINE_ACCELERATION_EXT.0; }
}
///[Vulkan Manual Page](https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/VkPipelineCreationFeedbackFlagBitsEXT.html) · Bits enum of [`PipelineCreationFeedbackFlagsEXT`]
        ...
        f
            .write_str(
                match self {
                    ...
                    &Self::APPLICATION_PIPELINE_CACHE_HIT_EXT => {
                        "APPLICATION_PIPELINE_CACHE_HIT_EXT"
                    }
                    &Self::BASE_PIPELINE_ACCELERATION_EXT => {
                        "BASE_PIPELINE_ACCELERATION_EXT"
                    }
                    _ => "(unknown variant)",
                },
...
impl<'a> crate::ExtendableFrom<'a, PipelineCreationFeedbackCreateInfoEXT>
for crate::vk1_0::ComputePipelineCreateInfoBuilder<'a> {}
impl<'a> crate::ExtendableFrom<'a, PipelineCreationFeedbackCreateInfoEXTBuilder<'_>>
for crate::vk1_0::ComputePipelineCreateInfoBuilder<'a> {}
impl<'a> crate::ExtendableFrom<'a, PipelineCreationFeedbackCreateInfoEXT>
...
for crate::extensions::khr_ray_tracing_pipeline::RayTracingPipelineCreateInfoKHRBuilder<
    'a,
> {}
///[Vulkan Manual Page](https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/VkPipelineCreationFeedbackEXT.html) · Structure
...
impl std::fmt::Debug for PipelineCreationFeedbackEXT {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f
            .debug_struct("PipelineCreationFeedbackEXT")
...
#[derive(Copy, Clone)]
///[Vulkan Manual Page](https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/VkPipelineCreationFeedbackEXT.html) · Builder of [`PipelineCreationFeedbackEXT`]
#[repr(transparent)]
...
///[Vulkan Manual Page](https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/VkPipelineCreationFeedbackCreateInfoEXT.html) · Structure
...
impl std::fmt::Debug for PipelineCreationFeedbackCreateInfoEXT {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f
            .debug_struct("PipelineCreationFeedbackCreateInfoEXT")
...
#[derive(Copy, Clone)]
///[Vulkan Manual Page](https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/VkPipelineCreationFeedbackCreateInfoEXT.html) · Builder of [`PipelineCreationFeedbackCreateInfoEXT`]
#[repr(transparent)]
