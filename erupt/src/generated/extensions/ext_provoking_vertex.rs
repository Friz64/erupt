...
pub const EXT_PROVOKING_VERTEX_EXTENSION_NAME: *const std::os::raw::c_char = crate::cstr!(
...
impl<'a> crate::ExtendableFrom<'a, PhysicalDeviceProvokingVertexFeaturesEXT>
for crate::vk1_0::DeviceCreateInfoBuilder<'a> {}
impl<'a> crate::ExtendableFrom<'a, PhysicalDeviceProvokingVertexFeaturesEXTBuilder<'_>>
for crate::vk1_0::DeviceCreateInfoBuilder<'a> {}
impl<
    'a,
> crate::ExtendableFrom<'a, PipelineRasterizationProvokingVertexStateCreateInfoEXT>
for crate::vk1_0::PipelineRasterizationStateCreateInfoBuilder<'a> {}
impl<
    'a,
> crate::ExtendableFrom<
    'a,
    PipelineRasterizationProvokingVertexStateCreateInfoEXTBuilder<'_>,
> for crate::vk1_0::PipelineRasterizationStateCreateInfoBuilder<'a> {}
impl<'a> crate::ExtendableFrom<'a, PhysicalDeviceProvokingVertexFeaturesEXT>
for crate::vk1_1::PhysicalDeviceFeatures2Builder<'a> {}
impl<'a> crate::ExtendableFrom<'a, PhysicalDeviceProvokingVertexFeaturesEXTBuilder<'_>>
for crate::vk1_1::PhysicalDeviceFeatures2Builder<'a> {}
impl<'a> crate::ExtendableFrom<'a, PhysicalDeviceProvokingVertexPropertiesEXT>
    ...
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f
            ...
            .field(
                ...
                &(self.transform_feedback_preserves_provoking_vertex != 0),
            )
            .finish()
    }
}
...
impl<'a> PhysicalDeviceProvokingVertexFeaturesEXTBuilder<'a> {
    ...
    pub fn transform_feedback_preserves_provoking_vertex(
        ...
        self
            .0
            .transform_feedback_preserves_provoking_vertex = transform_feedback_preserves_provoking_vertex
            as _;
        self
    }
    #[inline]
    ...
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f
            ...
            .field(
                ...
                &(self.provoking_vertex_mode_per_pipeline != 0),
            )
            .field(
                "transform_feedback_preserves_triangle_fan_provoking_vertex",
                &(self.transform_feedback_preserves_triangle_fan_provoking_vertex != 0),
            )
            .finish()
    }
}
impl PhysicalDeviceProvokingVertexPropertiesEXT {
    ...
    pub fn into_builder<'a>(
        self,
    ) -> PhysicalDeviceProvokingVertexPropertiesEXTBuilder<'a> {
...
impl<'a> PhysicalDeviceProvokingVertexPropertiesEXTBuilder<'a> {
    ...
    pub fn provoking_vertex_mode_per_pipeline(
        ...
        self
            .0
            .provoking_vertex_mode_per_pipeline = provoking_vertex_mode_per_pipeline
            as _;
        self
    }
    #[inline]
    ...
    pub fn transform_feedback_preserves_triangle_fan_provoking_vertex(
        ...
        self
            .0
            .transform_feedback_preserves_triangle_fan_provoking_vertex = transform_feedback_preserves_triangle_fan_provoking_vertex
            as _;
        self
    }
    #[inline]
...
for PhysicalDeviceProvokingVertexPropertiesEXTBuilder<'a> {
...
impl PipelineRasterizationProvokingVertexStateCreateInfoEXT {
    ...
    pub fn into_builder<'a>(
        self,
    ) -> PipelineRasterizationProvokingVertexStateCreateInfoEXTBuilder<'a> {
