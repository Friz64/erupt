...
pub const EXT_RGBA10X6_FORMATS_EXTENSION_NAME: *const std::os::raw::c_char = crate::cstr!(
    "VK_EXT_rgba10x6_formats"
);
///Provided by [`crate::extensions::ext_rgba10x6_formats`]
impl crate::vk1_0::StructureType {
    pub const PHYSICAL_DEVICE_RGBA10X6_FORMATS_FEATURES_EXT: Self = Self(1000344000);
}
impl<'a> crate::ExtendableFrom<'a, PhysicalDeviceRGBA10X6FormatsFeaturesEXT>
...
impl std::fmt::Debug for PhysicalDeviceRGBA10X6FormatsFeaturesEXT {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f
            .debug_struct("PhysicalDeviceRGBA10X6FormatsFeaturesEXT")
            .field("s_type", &self.s_type)
            .field("p_next", &self.p_next)
            .field(
                "format_rgba10x6_without_y_cb_cr_sampler",
                &(self.format_rgba10x6_without_y_cb_cr_sampler != 0),
            )
            .finish()
    }
}
impl PhysicalDeviceRGBA10X6FormatsFeaturesEXT {
    ...
    pub fn into_builder<'a>(
        self,
    ) -> PhysicalDeviceRGBA10X6FormatsFeaturesEXTBuilder<'a> {
...
impl<'a> PhysicalDeviceRGBA10X6FormatsFeaturesEXTBuilder<'a> {
    ...
    pub fn format_rgba10x6_without_y_cb_cr_sampler(
        ...
        self
            .0
            .format_rgba10x6_without_y_cb_cr_sampler = format_rgba10x6_without_y_cb_cr_sampler
            as _;
        self
    }
    #[inline]
