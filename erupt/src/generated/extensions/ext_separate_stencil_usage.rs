...
pub const EXT_SEPARATE_STENCIL_USAGE_EXTENSION_NAME: *const std::os::raw::c_char =
    crate::cstr!("VK_EXT_separate_stencil_usage");
...
#[doc(alias = "VkImageStencilUsageCreateInfoEXT")]
#[allow(non_camel_case_types)]
pub type ImageStencilUsageCreateInfoEXTBuilder<'a> =
    crate::vk1_2::ImageStencilUsageCreateInfoBuilder<'a>;
