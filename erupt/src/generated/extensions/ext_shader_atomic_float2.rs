...
pub const EXT_SHADER_ATOMIC_FLOAT_2_EXTENSION_NAME: *const std::os::raw::c_char = crate::cstr!(
    "VK_EXT_shader_atomic_float2"
);
///Provided by [`crate::extensions::ext_shader_atomic_float2`]
impl crate::vk1_0::StructureType {
    pub const PHYSICAL_DEVICE_SHADER_ATOMIC_FLOAT_2_FEATURES_EXT: Self = Self(
        1000273000,
    );
}
impl<'a> crate::ExtendableFrom<'a, PhysicalDeviceShaderAtomicFloat2FeaturesEXT>
    ...
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct("PhysicalDeviceShaderAtomicFloat2FeaturesEXT")
            ...
            .field(
                ...
                &(self.shader_buffer_float16_atomics != 0),
            )
            .field(
                "shader_buffer_float16_atomic_add",
                &(self.shader_buffer_float16_atomic_add != 0),
            )
            .field(
                "shader_buffer_float16_atomic_min_max",
                &(self.shader_buffer_float16_atomic_min_max != 0),
            )
            .field(
                "shader_buffer_float32_atomic_min_max",
                &(self.shader_buffer_float32_atomic_min_max != 0),
            )
            .field(
                "shader_buffer_float64_atomic_min_max",
                &(self.shader_buffer_float64_atomic_min_max != 0),
            )
            .field(
                "shader_shared_float16_atomics",
                &(self.shader_shared_float16_atomics != 0),
            )
            .field(
                "shader_shared_float16_atomic_add",
                &(self.shader_shared_float16_atomic_add != 0),
            )
            .field(
                "shader_shared_float16_atomic_min_max",
                &(self.shader_shared_float16_atomic_min_max != 0),
            )
            .field(
                "shader_shared_float32_atomic_min_max",
                &(self.shader_shared_float32_atomic_min_max != 0),
            )
            .field(
                "shader_shared_float64_atomic_min_max",
                &(self.shader_shared_float64_atomic_min_max != 0),
            )
            .field(
                "shader_image_float32_atomic_min_max",
                &(self.shader_image_float32_atomic_min_max != 0),
            )
            .field(
                "sparse_image_float32_atomic_min_max",
                &(self.sparse_image_float32_atomic_min_max != 0),
            )
            .finish()
    }
}
impl PhysicalDeviceShaderAtomicFloat2FeaturesEXT {
    ...
    pub fn into_builder<'a>(
        self,
    ) -> PhysicalDeviceShaderAtomicFloat2FeaturesEXTBuilder<'a> {
...
impl<'a> PhysicalDeviceShaderAtomicFloat2FeaturesEXTBuilder<'a> {
    ...
    pub fn shader_buffer_float16_atomic_min_max(
        ...
        self
            .0
            .shader_buffer_float16_atomic_min_max = shader_buffer_float16_atomic_min_max
            as _;
        self
    }
    #[inline]
    ...
    pub fn shader_shared_float16_atomic_min_max(
        ...
        self
            .0
            .shader_shared_float16_atomic_min_max = shader_shared_float16_atomic_min_max
            as _;
        self
    }
    #[inline]
    ...
    pub fn shader_shared_float32_atomic_min_max(
        ...
        self
            .0
            .shader_shared_float32_atomic_min_max = shader_shared_float32_atomic_min_max
            as _;
        self
    }
    #[inline]
    ...
    pub fn shader_shared_float64_atomic_min_max(
        ...
        self
            .0
            .shader_shared_float64_atomic_min_max = shader_shared_float64_atomic_min_max
            as _;
        self
    }
    #[inline]
    ...
    pub fn shader_image_float32_atomic_min_max(
        ...
        self
            .0
            .shader_image_float32_atomic_min_max = shader_image_float32_atomic_min_max
            as _;
        self
    }
    #[inline]
    ...
    pub fn sparse_image_float32_atomic_min_max(
        ...
        self
            .0
            .sparse_image_float32_atomic_min_max = sparse_image_float32_atomic_min_max
            as _;
        self
    }
    #[inline]
...
for PhysicalDeviceShaderAtomicFloat2FeaturesEXTBuilder<'a> {
