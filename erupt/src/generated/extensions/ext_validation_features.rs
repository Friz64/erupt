...
pub const EXT_VALIDATION_FEATURES_EXTENSION_NAME: *const std::os::raw::c_char = crate::cstr!(
...
impl<'a> crate::ExtendableFrom<'a, ValidationFeaturesEXT>
...
impl<'a> ValidationFeaturesEXTBuilder<'a> {
    ...
    pub fn disabled_validation_features(
        ...
        self
            .0
            .p_disabled_validation_features = disabled_validation_features.as_ptr() as _;
        self
            .0
            .disabled_validation_feature_count = disabled_validation_features.len() as _;
        self
    }
    #[inline]
