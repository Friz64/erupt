...
pub const GOOGLE_HLSL_FUNCTIONALITY_1_EXTENSION_NAME: *const std::os::raw::c_char = crate::cstr!("VK_GOOGLE_hlsl_functionality1");
#[doc = "<s>Vulkan Manual Page</s> · Constant"]
#[deprecated]
...
pub const GOOGLE_HLSL_FUNCTIONALITY1_EXTENSION_NAME: *const std::os::raw::c_char = crate::cstr!("VK_GOOGLE_hlsl_functionality1");
