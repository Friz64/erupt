...
pub const HUAWEI_INVOCATION_MASK_EXTENSION_NAME: *const std::os::raw::c_char = crate::cstr!(
    "VK_HUAWEI_invocation_mask"
);
///<s>Vulkan Manual Page</s> · Constant
pub const FN_CMD_BIND_INVOCATION_MASK_HUAWEI: *const std::os::raw::c_char = crate::cstr!(
...
for PhysicalDeviceInvocationMaskFeaturesHUAWEIBuilder<'a> {
