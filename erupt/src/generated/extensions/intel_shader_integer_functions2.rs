...
pub const INTEL_SHADER_INTEGER_FUNCTIONS_2_EXTENSION_NAME: *const std::os::raw::c_char = crate::cstr!(
    "VK_INTEL_shader_integer_functions2"
);
///Provided by [`crate::extensions::intel_shader_integer_functions2`]
impl crate::vk1_0::StructureType {
    pub const PHYSICAL_DEVICE_SHADER_INTEGER_FUNCTIONS_2_FEATURES_INTEL: Self = Self(
        1000209000,
    );
}
impl<'a> crate::ExtendableFrom<'a, PhysicalDeviceShaderIntegerFunctions2FeaturesINTEL>
