...
pub const KHR_BUFFER_DEVICE_ADDRESS_EXTENSION_NAME: *const std::os::raw::c_char = crate::cstr!("VK_KHR_buffer_device_address");
#[doc = "<s>Vulkan Manual Page</s> · Constant"]
pub const FN_GET_BUFFER_OPAQUE_CAPTURE_ADDRESS_KHR: *const std::os::raw::c_char = crate::cstr!("vkGetBufferOpaqueCaptureAddressKHR");
#[doc = "<s>Vulkan Manual Page</s> · Constant"]
pub const FN_GET_BUFFER_DEVICE_ADDRESS_KHR: *const std::os::raw::c_char = crate::cstr!("vkGetBufferDeviceAddressKHR");
#[doc = "<s>Vulkan Manual Page</s> · Constant"]
pub const FN_GET_DEVICE_MEMORY_OPAQUE_CAPTURE_ADDRESS_KHR: *const std::os::raw::c_char = crate::cstr!("vkGetDeviceMemoryOpaqueCaptureAddressKHR");
...
#[doc(alias = "VkPhysicalDeviceBufferDeviceAddressFeaturesKHR")]
#[allow(non_camel_case_types)]
pub type PhysicalDeviceBufferDeviceAddressFeaturesKHRBuilder<'a> = crate::vk1_2::PhysicalDeviceBufferDeviceAddressFeaturesBuilder<'a>;
...
#[doc(alias = "VkBufferOpaqueCaptureAddressCreateInfoKHR")]
#[allow(non_camel_case_types)]
pub type BufferOpaqueCaptureAddressCreateInfoKHRBuilder<'a> = crate::vk1_2::BufferOpaqueCaptureAddressCreateInfoBuilder<'a>;
...
#[doc(alias = "VkMemoryOpaqueCaptureAddressAllocateInfoKHR")]
#[allow(non_camel_case_types)]
pub type MemoryOpaqueCaptureAddressAllocateInfoKHRBuilder<'a> = crate::vk1_2::MemoryOpaqueCaptureAddressAllocateInfoBuilder<'a>;
...
#[doc(alias = "VkDeviceMemoryOpaqueCaptureAddressInfoKHR")]
#[allow(non_camel_case_types)]
pub type DeviceMemoryOpaqueCaptureAddressInfoKHRBuilder<'a> = crate::vk1_2::DeviceMemoryOpaqueCaptureAddressInfoBuilder<'a>;
...
impl crate::DeviceLoader {
    ...
    pub unsafe fn get_buffer_opaque_capture_address_khr(&self, info: &crate::vk1_2::BufferDeviceAddressInfo) -> u64 {
        let _function = self.get_buffer_opaque_capture_address_khr.expect("`get_buffer_opaque_capture_address_khr` is not loaded");
    ...
    pub unsafe fn get_buffer_device_address_khr(&self, info: &crate::vk1_2::BufferDeviceAddressInfo) -> crate::vk1_0::DeviceAddress {
        let _function = self.get_buffer_device_address_khr.expect("`get_buffer_device_address_khr` is not loaded");
        let _return = _function(self.handle, info as _);
        _return
    }
    #[inline]
    ...
    pub unsafe fn get_device_memory_opaque_capture_address_khr(&self, info: &crate::vk1_2::DeviceMemoryOpaqueCaptureAddressInfo) -> u64 {
        let _function = self.get_device_memory_opaque_capture_address_khr.expect("`get_device_memory_opaque_capture_address_khr` is not loaded");
        let _return = _function(self.handle, info as _);
        _return
    }
}
