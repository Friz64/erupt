...
pub const KHR_DEVICE_GROUP_EXTENSION_NAME: *const std::os::raw::c_char = crate::cstr!(
    "VK_KHR_device_group"
);
///<s>Vulkan Manual Page</s> · Constant
pub const FN_GET_DEVICE_GROUP_PEER_MEMORY_FEATURES_KHR: *const std::os::raw::c_char = crate::cstr!(
    "vkGetDeviceGroupPeerMemoryFeaturesKHR"
);
///<s>Vulkan Manual Page</s> · Constant
pub const FN_CMD_SET_DEVICE_MASK_KHR: *const std::os::raw::c_char = crate::cstr!(
