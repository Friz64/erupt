...
pub const KHR_DRAW_INDIRECT_COUNT_EXTENSION_NAME: *const std::os::raw::c_char = crate::cstr!(
    "VK_KHR_draw_indirect_count"
);
///<s>Vulkan Manual Page</s> · Constant
pub const FN_CMD_DRAW_INDIRECT_COUNT_KHR: *const std::os::raw::c_char = crate::cstr!(
