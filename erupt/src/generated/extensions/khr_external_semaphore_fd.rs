...
pub const KHR_EXTERNAL_SEMAPHORE_FD_EXTENSION_NAME: *const std::os::raw::c_char = crate::cstr!(
    "VK_KHR_external_semaphore_fd"
);
///<s>Vulkan Manual Page</s> · Constant
pub const FN_GET_SEMAPHORE_FD_KHR: *const std::os::raw::c_char = crate::cstr!(
    "vkGetSemaphoreFdKHR"
);
///<s>Vulkan Manual Page</s> · Constant
pub const FN_IMPORT_SEMAPHORE_FD_KHR: *const std::os::raw::c_char = crate::cstr!(
