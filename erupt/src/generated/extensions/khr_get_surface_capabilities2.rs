...
impl crate::InstanceLoader {
    ...
    pub unsafe fn get_physical_device_surface_formats2_khr(&self, physical_device: crate::vk1_0::PhysicalDevice, surface_info: &crate::extensions::khr_get_surface_capabilities2::PhysicalDeviceSurfaceInfo2KHR, surface_format_count: Option<u32>, surface_formats_callback: impl FnMut(&mut crate::SmallVec<crate::extensions::khr_get_surface_capabilities2::SurfaceFormat2KHR>) -> ()) -> crate::utils::VulkanResult<crate::SmallVec<crate::extensions::khr_get_surface_capabilities2::SurfaceFormat2KHR>> {
        ...
        let mut _callback = surface_formats_callback;
