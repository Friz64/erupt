...
///[Vulkan Manual Page](https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/vkGetDeviceBufferMemoryRequirementsKHR.html) · Function
#[allow(non_camel_case_types)]
pub type PFN_vkGetDeviceBufferMemoryRequirementsKHR = unsafe extern "system" fn(
        device: crate::vk1_0::Device,
        p_info: *const crate::extensions::khr_maintenance4::DeviceBufferMemoryRequirementsKHR,
        p_memory_requirements: *mut crate::vk1_1::MemoryRequirements2,
    ) -> ();
///[Vulkan Manual Page](https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/vkGetDeviceImageMemoryRequirementsKHR.html) · Function
#[allow(non_camel_case_types)]
pub type PFN_vkGetDeviceImageMemoryRequirementsKHR = unsafe extern "system" fn(
        device: crate::vk1_0::Device,
        p_info: *const crate::extensions::khr_maintenance4::DeviceImageMemoryRequirementsKHR,
        p_memory_requirements: *mut crate::vk1_1::MemoryRequirements2,
    ) -> ();
///[Vulkan Manual Page](https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/vkGetDeviceImageSparseMemoryRequirementsKHR.html) · Function
#[allow(non_camel_case_types)]
...
impl<'a> crate::ExtendableFrom<'a, PhysicalDeviceMaintenance4FeaturesKHR>
for crate::vk1_0::DeviceCreateInfoBuilder<'a> {}
impl<'a> crate::ExtendableFrom<'a, PhysicalDeviceMaintenance4FeaturesKHRBuilder<'_>>
for crate::vk1_0::DeviceCreateInfoBuilder<'a> {}
impl<'a> crate::ExtendableFrom<'a, PhysicalDeviceMaintenance4FeaturesKHR>
for crate::vk1_1::PhysicalDeviceFeatures2Builder<'a> {}
impl<'a> crate::ExtendableFrom<'a, PhysicalDeviceMaintenance4FeaturesKHRBuilder<'_>>
for crate::vk1_1::PhysicalDeviceFeatures2Builder<'a> {}
impl<'a> crate::ExtendableFrom<'a, PhysicalDeviceMaintenance4PropertiesKHR>
for crate::vk1_1::PhysicalDeviceProperties2Builder<'a> {}
impl<'a> crate::ExtendableFrom<'a, PhysicalDeviceMaintenance4PropertiesKHRBuilder<'_>>
for crate::vk1_1::PhysicalDeviceProperties2Builder<'a> {}
///[Vulkan Manual Page](https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/VkDeviceBufferMemoryRequirementsKHR.html) · Structure
...
impl std::fmt::Debug for DeviceBufferMemoryRequirementsKHR {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f
            .debug_struct("DeviceBufferMemoryRequirementsKHR")
...
#[derive(Copy, Clone)]
///[Vulkan Manual Page](https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/VkDeviceBufferMemoryRequirementsKHR.html) · Builder of [`DeviceBufferMemoryRequirementsKHR`]
#[repr(transparent)]
...
///[Vulkan Manual Page](https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/VkDeviceImageMemoryRequirementsKHR.html) · Structure
...
impl std::fmt::Debug for DeviceImageMemoryRequirementsKHR {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f
            .debug_struct("DeviceImageMemoryRequirementsKHR")
            .field("s_type", &self.s_type)
            .field("p_next", &self.p_next)
            .field("p_create_info", &self.p_create_info)
...
#[derive(Copy, Clone)]
///[Vulkan Manual Page](https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/VkDeviceImageMemoryRequirementsKHR.html) · Builder of [`DeviceImageMemoryRequirementsKHR`]
#[repr(transparent)]
...
///[Vulkan Manual Page](https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/VkPhysicalDeviceMaintenance4FeaturesKHR.html) · Structure
...
impl std::fmt::Debug for PhysicalDeviceMaintenance4FeaturesKHR {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f
            .debug_struct("PhysicalDeviceMaintenance4FeaturesKHR")
            .field("s_type", &self.s_type)
            .field("p_next", &self.p_next)
...
#[derive(Copy, Clone)]
///[Vulkan Manual Page](https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/VkPhysicalDeviceMaintenance4FeaturesKHR.html) · Builder of [`PhysicalDeviceMaintenance4FeaturesKHR`]
#[repr(transparent)]
...
///[Vulkan Manual Page](https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/VkPhysicalDeviceMaintenance4PropertiesKHR.html) · Structure
...
impl std::fmt::Debug for PhysicalDeviceMaintenance4PropertiesKHR {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f
            .debug_struct("PhysicalDeviceMaintenance4PropertiesKHR")
            .field("s_type", &self.s_type)
            .field("p_next", &self.p_next)
...
#[derive(Copy, Clone)]
///[Vulkan Manual Page](https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/VkPhysicalDeviceMaintenance4PropertiesKHR.html) · Builder of [`PhysicalDeviceMaintenance4PropertiesKHR`]
#[repr(transparent)]
...
impl crate::DeviceLoader {
    ...
    pub unsafe fn get_device_buffer_memory_requirements_khr(
        &self,
        info: &crate::extensions::khr_maintenance4::DeviceBufferMemoryRequirementsKHR,
    ...
    pub unsafe fn get_device_image_memory_requirements_khr(
        &self,
        info: &crate::extensions::khr_maintenance4::DeviceImageMemoryRequirementsKHR,
        memory_requirements: Option<crate::vk1_1::MemoryRequirements2>,
    ) -> crate::vk1_1::MemoryRequirements2 {
        let _function = self
