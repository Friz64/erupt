...
impl crate::InstanceLoader {
    ...
    pub unsafe fn enumerate_physical_device_queue_family_performance_query_counters_khr(&self, physical_device: crate::vk1_0::PhysicalDevice, queue_family_index: u32, counter_count: Option<u32>, counters_callback: impl FnMut(&mut crate::SmallVec<crate::extensions::khr_performance_query::PerformanceCounterKHR>) -> (), counter_descriptions_callback: impl FnMut(&mut crate::SmallVec<crate::extensions::khr_performance_query::PerformanceCounterDescriptionKHR>) -> ()) -> crate::utils::VulkanResult<(crate::SmallVec<crate::extensions::khr_performance_query::PerformanceCounterKHR>, crate::SmallVec<crate::extensions::khr_performance_query::PerformanceCounterDescriptionKHR>)> {
