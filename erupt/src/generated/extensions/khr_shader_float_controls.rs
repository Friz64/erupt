...
pub const KHR_SHADER_FLOAT_CONTROLS_EXTENSION_NAME: *const std::os::raw::c_char =
    crate::cstr!("VK_KHR_shader_float_controls");
...
#[allow(non_camel_case_types)]
pub type PhysicalDeviceFloatControlsPropertiesKHR =
    crate::vk1_2::PhysicalDeviceFloatControlsProperties;
#[doc = "[Vulkan Manual Page](https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/VkPhysicalDeviceFloatControlsPropertiesKHR.html) · Alias"]
#[doc(alias = "VkPhysicalDeviceFloatControlsPropertiesKHR")]
#[allow(non_camel_case_types)]
pub type PhysicalDeviceFloatControlsPropertiesKHRBuilder<'a> =
    crate::vk1_2::PhysicalDeviceFloatControlsPropertiesBuilder<'a>;
