...
pub const KHR_SHADER_SUBGROUP_UNIFORM_CONTROL_FLOW_EXTENSION_NAME: *const std::os::raw::c_char = crate::cstr!(
...
impl<
    'a,
> crate::ExtendableFrom<'a, PhysicalDeviceShaderSubgroupUniformControlFlowFeaturesKHR>
for crate::vk1_0::DeviceCreateInfoBuilder<'a> {}
impl<
    'a,
> crate::ExtendableFrom<
    'a,
    PhysicalDeviceShaderSubgroupUniformControlFlowFeaturesKHRBuilder<'_>,
> for crate::vk1_0::DeviceCreateInfoBuilder<'a> {}
impl<
    'a,
> crate::ExtendableFrom<'a, PhysicalDeviceShaderSubgroupUniformControlFlowFeaturesKHR>
...
> crate::ExtendableFrom<
    ...
    PhysicalDeviceShaderSubgroupUniformControlFlowFeaturesKHRBuilder<'_>,
> for crate::vk1_1::PhysicalDeviceFeatures2Builder<'a> {}
///[Vulkan Manual Page](https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/VkPhysicalDeviceShaderSubgroupUniformControlFlowFeaturesKHR.html) · Structure
...
impl std::fmt::Debug for PhysicalDeviceShaderSubgroupUniformControlFlowFeaturesKHR {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f
            .debug_struct("PhysicalDeviceShaderSubgroupUniformControlFlowFeaturesKHR")
            .field("s_type", &self.s_type)
            .field("p_next", &self.p_next)
            .field(
                "shader_subgroup_uniform_control_flow",
                &(self.shader_subgroup_uniform_control_flow != 0),
            )
            .finish()
    }
}
impl PhysicalDeviceShaderSubgroupUniformControlFlowFeaturesKHR {
    ...
    pub fn into_builder<'a>(
        self,
    ) -> PhysicalDeviceShaderSubgroupUniformControlFlowFeaturesKHRBuilder<'a> {
...
#[derive(Copy, Clone)]
///[Vulkan Manual Page](https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/VkPhysicalDeviceShaderSubgroupUniformControlFlowFeaturesKHR.html) · Builder of [`PhysicalDeviceShaderSubgroupUniformControlFlowFeaturesKHR`]
#[repr(transparent)]
...
impl<'a> PhysicalDeviceShaderSubgroupUniformControlFlowFeaturesKHRBuilder<'a> {
    #[inline]
    pub fn new() -> PhysicalDeviceShaderSubgroupUniformControlFlowFeaturesKHRBuilder<
            'a,
        > {
        PhysicalDeviceShaderSubgroupUniformControlFlowFeaturesKHRBuilder(
            Default::default(),
    ...
    pub fn shader_subgroup_uniform_control_flow(
        ...
        self
            .0
            .shader_subgroup_uniform_control_flow = shader_subgroup_uniform_control_flow
            as _;
        self
    }
    #[inline]
...
for PhysicalDeviceShaderSubgroupUniformControlFlowFeaturesKHRBuilder<'a> {
    fn default() -> PhysicalDeviceShaderSubgroupUniformControlFlowFeaturesKHRBuilder<
            'a,
        > {
        Self::new()
    }
