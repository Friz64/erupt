...
///[Vulkan Manual Page](https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/VkFlags64.html) · Basetype
#[doc(alias = "VkFlags64")]
pub type Flags64 = u64;
bitflags::bitflags! {
    #[doc =
    "[Vulkan Manual Page](https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/VkAccessFlags2KHR.html) · Bitmask of [`AccessFlagBits2KHR`]"]
    #[doc(alias = "VkAccessFlags2KHR")] #[derive(Default)] #[repr(transparent)] pub
    struct AccessFlags2KHR : u64 { const NONE_KHR = AccessFlagBits2KHR::NONE_KHR.0; const
    INDIRECT_COMMAND_READ_KHR = AccessFlagBits2KHR::INDIRECT_COMMAND_READ_KHR.0; const
    INDEX_READ_KHR = AccessFlagBits2KHR::INDEX_READ_KHR.0; const
    VERTEX_ATTRIBUTE_READ_KHR = AccessFlagBits2KHR::VERTEX_ATTRIBUTE_READ_KHR.0; const
    UNIFORM_READ_KHR = AccessFlagBits2KHR::UNIFORM_READ_KHR.0; const
    INPUT_ATTACHMENT_READ_KHR = AccessFlagBits2KHR::INPUT_ATTACHMENT_READ_KHR.0; const
    SHADER_READ_KHR = AccessFlagBits2KHR::SHADER_READ_KHR.0; const SHADER_WRITE_KHR =
    AccessFlagBits2KHR::SHADER_WRITE_KHR.0; const COLOR_ATTACHMENT_READ_KHR =
    AccessFlagBits2KHR::COLOR_ATTACHMENT_READ_KHR.0; const COLOR_ATTACHMENT_WRITE_KHR =
    AccessFlagBits2KHR::COLOR_ATTACHMENT_WRITE_KHR.0; const
    DEPTH_STENCIL_ATTACHMENT_READ_KHR =
    AccessFlagBits2KHR::DEPTH_STENCIL_ATTACHMENT_READ_KHR.0; const
    DEPTH_STENCIL_ATTACHMENT_WRITE_KHR =
    AccessFlagBits2KHR::DEPTH_STENCIL_ATTACHMENT_WRITE_KHR.0; const TRANSFER_READ_KHR =
    AccessFlagBits2KHR::TRANSFER_READ_KHR.0; const TRANSFER_WRITE_KHR =
    AccessFlagBits2KHR::TRANSFER_WRITE_KHR.0; const HOST_READ_KHR =
    AccessFlagBits2KHR::HOST_READ_KHR.0; const HOST_WRITE_KHR =
    AccessFlagBits2KHR::HOST_WRITE_KHR.0; const MEMORY_READ_KHR =
    AccessFlagBits2KHR::MEMORY_READ_KHR.0; const MEMORY_WRITE_KHR =
    AccessFlagBits2KHR::MEMORY_WRITE_KHR.0; const SHADER_SAMPLED_READ_KHR =
    AccessFlagBits2KHR::SHADER_SAMPLED_READ_KHR.0; const SHADER_STORAGE_READ_KHR =
    AccessFlagBits2KHR::SHADER_STORAGE_READ_KHR.0; const SHADER_STORAGE_WRITE_KHR =
    AccessFlagBits2KHR::SHADER_STORAGE_WRITE_KHR.0; const VIDEO_DECODE_READ_KHR =
    AccessFlagBits2KHR::VIDEO_DECODE_READ_KHR.0; const VIDEO_DECODE_WRITE_KHR =
    AccessFlagBits2KHR::VIDEO_DECODE_WRITE_KHR.0; const VIDEO_ENCODE_READ_KHR =
    AccessFlagBits2KHR::VIDEO_ENCODE_READ_KHR.0; const VIDEO_ENCODE_WRITE_KHR =
    AccessFlagBits2KHR::VIDEO_ENCODE_WRITE_KHR.0; const TRANSFORM_FEEDBACK_WRITE_EXT =
    AccessFlagBits2KHR::TRANSFORM_FEEDBACK_WRITE_EXT.0; const
    TRANSFORM_FEEDBACK_COUNTER_READ_EXT =
    AccessFlagBits2KHR::TRANSFORM_FEEDBACK_COUNTER_READ_EXT.0; const
    TRANSFORM_FEEDBACK_COUNTER_WRITE_EXT =
    AccessFlagBits2KHR::TRANSFORM_FEEDBACK_COUNTER_WRITE_EXT.0; const
    CONDITIONAL_RENDERING_READ_EXT =
    AccessFlagBits2KHR::CONDITIONAL_RENDERING_READ_EXT.0; const
    COMMAND_PREPROCESS_READ_NV = AccessFlagBits2KHR::COMMAND_PREPROCESS_READ_NV.0; const
    COMMAND_PREPROCESS_WRITE_NV = AccessFlagBits2KHR::COMMAND_PREPROCESS_WRITE_NV.0;
    const FRAGMENT_SHADING_RATE_ATTACHMENT_READ_KHR =
    AccessFlagBits2KHR::FRAGMENT_SHADING_RATE_ATTACHMENT_READ_KHR.0; const
    SHADING_RATE_IMAGE_READ_NV = AccessFlagBits2KHR::SHADING_RATE_IMAGE_READ_NV.0; const
    ACCELERATION_STRUCTURE_READ_KHR =
    AccessFlagBits2KHR::ACCELERATION_STRUCTURE_READ_KHR.0; const
    ACCELERATION_STRUCTURE_WRITE_KHR =
    AccessFlagBits2KHR::ACCELERATION_STRUCTURE_WRITE_KHR.0; const
    ACCELERATION_STRUCTURE_READ_NV =
    AccessFlagBits2KHR::ACCELERATION_STRUCTURE_READ_NV.0; const
    ACCELERATION_STRUCTURE_WRITE_NV =
    AccessFlagBits2KHR::ACCELERATION_STRUCTURE_WRITE_NV.0; const
    FRAGMENT_DENSITY_MAP_READ_EXT = AccessFlagBits2KHR::FRAGMENT_DENSITY_MAP_READ_EXT.0;
    const COLOR_ATTACHMENT_READ_NONCOHERENT_EXT =
    AccessFlagBits2KHR::COLOR_ATTACHMENT_READ_NONCOHERENT_EXT.0; const
    INVOCATION_MASK_READ_HUAWEI = AccessFlagBits2KHR::INVOCATION_MASK_READ_HUAWEI.0; }
}
///[Vulkan Manual Page](https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/VkAccessFlagBits2KHR.html) · Bits enum of [`AccessFlags2KHR`]
...
bitflags::bitflags! {
    #[doc =
    "[Vulkan Manual Page](https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/VkPipelineStageFlags2KHR.html) · Bitmask of [`PipelineStageFlagBits2KHR`]"]
    #[doc(alias = "VkPipelineStageFlags2KHR")] #[derive(Default)] #[repr(transparent)]
    pub struct PipelineStageFlags2KHR : u64 { const NONE_KHR =
    PipelineStageFlagBits2KHR::NONE_KHR.0; const TOP_OF_PIPE_KHR =
    PipelineStageFlagBits2KHR::TOP_OF_PIPE_KHR.0; const DRAW_INDIRECT_KHR =
    PipelineStageFlagBits2KHR::DRAW_INDIRECT_KHR.0; const VERTEX_INPUT_KHR =
    PipelineStageFlagBits2KHR::VERTEX_INPUT_KHR.0; const VERTEX_SHADER_KHR =
    PipelineStageFlagBits2KHR::VERTEX_SHADER_KHR.0; const TESSELLATION_CONTROL_SHADER_KHR
    = PipelineStageFlagBits2KHR::TESSELLATION_CONTROL_SHADER_KHR.0; const
    TESSELLATION_EVALUATION_SHADER_KHR =
    PipelineStageFlagBits2KHR::TESSELLATION_EVALUATION_SHADER_KHR.0; const
    GEOMETRY_SHADER_KHR = PipelineStageFlagBits2KHR::GEOMETRY_SHADER_KHR.0; const
    FRAGMENT_SHADER_KHR = PipelineStageFlagBits2KHR::FRAGMENT_SHADER_KHR.0; const
    EARLY_FRAGMENT_TESTS_KHR = PipelineStageFlagBits2KHR::EARLY_FRAGMENT_TESTS_KHR.0;
    const LATE_FRAGMENT_TESTS_KHR = PipelineStageFlagBits2KHR::LATE_FRAGMENT_TESTS_KHR.0;
    const COLOR_ATTACHMENT_OUTPUT_KHR =
    PipelineStageFlagBits2KHR::COLOR_ATTACHMENT_OUTPUT_KHR.0; const COMPUTE_SHADER_KHR =
    PipelineStageFlagBits2KHR::COMPUTE_SHADER_KHR.0; const ALL_TRANSFER_KHR =
    PipelineStageFlagBits2KHR::ALL_TRANSFER_KHR.0; const TRANSFER_KHR =
    PipelineStageFlagBits2KHR::TRANSFER_KHR.0; const BOTTOM_OF_PIPE_KHR =
    PipelineStageFlagBits2KHR::BOTTOM_OF_PIPE_KHR.0; const HOST_KHR =
    PipelineStageFlagBits2KHR::HOST_KHR.0; const ALL_GRAPHICS_KHR =
    PipelineStageFlagBits2KHR::ALL_GRAPHICS_KHR.0; const ALL_COMMANDS_KHR =
    PipelineStageFlagBits2KHR::ALL_COMMANDS_KHR.0; const COPY_KHR =
    PipelineStageFlagBits2KHR::COPY_KHR.0; const RESOLVE_KHR =
    PipelineStageFlagBits2KHR::RESOLVE_KHR.0; const BLIT_KHR =
    PipelineStageFlagBits2KHR::BLIT_KHR.0; const CLEAR_KHR =
    PipelineStageFlagBits2KHR::CLEAR_KHR.0; const INDEX_INPUT_KHR =
    PipelineStageFlagBits2KHR::INDEX_INPUT_KHR.0; const VERTEX_ATTRIBUTE_INPUT_KHR =
    PipelineStageFlagBits2KHR::VERTEX_ATTRIBUTE_INPUT_KHR.0; const
    PRE_RASTERIZATION_SHADERS_KHR =
    PipelineStageFlagBits2KHR::PRE_RASTERIZATION_SHADERS_KHR.0; const VIDEO_DECODE_KHR =
    PipelineStageFlagBits2KHR::VIDEO_DECODE_KHR.0; const VIDEO_ENCODE_KHR =
    PipelineStageFlagBits2KHR::VIDEO_ENCODE_KHR.0; const TRANSFORM_FEEDBACK_EXT =
    PipelineStageFlagBits2KHR::TRANSFORM_FEEDBACK_EXT.0; const CONDITIONAL_RENDERING_EXT
    = PipelineStageFlagBits2KHR::CONDITIONAL_RENDERING_EXT.0; const COMMAND_PREPROCESS_NV
    = PipelineStageFlagBits2KHR::COMMAND_PREPROCESS_NV.0; const
    FRAGMENT_SHADING_RATE_ATTACHMENT_KHR =
    PipelineStageFlagBits2KHR::FRAGMENT_SHADING_RATE_ATTACHMENT_KHR.0; const
    SHADING_RATE_IMAGE_NV = PipelineStageFlagBits2KHR::SHADING_RATE_IMAGE_NV.0; const
    ACCELERATION_STRUCTURE_BUILD_KHR =
    PipelineStageFlagBits2KHR::ACCELERATION_STRUCTURE_BUILD_KHR.0; const
    RAY_TRACING_SHADER_KHR = PipelineStageFlagBits2KHR::RAY_TRACING_SHADER_KHR.0; const
    RAY_TRACING_SHADER_NV = PipelineStageFlagBits2KHR::RAY_TRACING_SHADER_NV.0; const
    ACCELERATION_STRUCTURE_BUILD_NV =
    PipelineStageFlagBits2KHR::ACCELERATION_STRUCTURE_BUILD_NV.0; const
    FRAGMENT_DENSITY_PROCESS_EXT =
    PipelineStageFlagBits2KHR::FRAGMENT_DENSITY_PROCESS_EXT.0; const TASK_SHADER_NV =
    PipelineStageFlagBits2KHR::TASK_SHADER_NV.0; const MESH_SHADER_NV =
    PipelineStageFlagBits2KHR::MESH_SHADER_NV.0; const SUBPASS_SHADING_HUAWEI =
    PipelineStageFlagBits2KHR::SUBPASS_SHADING_HUAWEI.0; const INVOCATION_MASK_HUAWEI =
    PipelineStageFlagBits2KHR::INVOCATION_MASK_HUAWEI.0; }
}
///[Vulkan Manual Page](https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/VkPipelineStageFlagBits2KHR.html) · Bits enum of [`PipelineStageFlags2KHR`]
...
bitflags::bitflags! {
    #[doc =
    "[Vulkan Manual Page](https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/VkSubmitFlagsKHR.html) · Bitmask of [`SubmitFlagBitsKHR`]"]
    #[doc(alias = "VkSubmitFlagsKHR")] #[derive(Default)] #[repr(transparent)] pub struct
    SubmitFlagsKHR : u32 { const PROTECTED_KHR = SubmitFlagBitsKHR::PROTECTED_KHR.0; }
}
///[Vulkan Manual Page](https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/VkSubmitFlagBitsKHR.html) · Bits enum of [`SubmitFlagsKHR`]
...
///[Vulkan Manual Page](https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/vkCmdSetEvent2KHR.html) · Function
...
///[Vulkan Manual Page](https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/vkCmdResetEvent2KHR.html) · Function
#[allow(non_camel_case_types)]
...
///[Vulkan Manual Page](https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/vkCmdWaitEvents2KHR.html) · Function
#[allow(non_camel_case_types)]
...
///[Vulkan Manual Page](https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/vkCmdPipelineBarrier2KHR.html) · Function
#[allow(non_camel_case_types)]
pub type PFN_vkCmdPipelineBarrier2KHR = unsafe extern "system" fn(
        command_buffer: crate::vk1_0::CommandBuffer,
        p_dependency_info: *const crate::extensions::khr_synchronization2::DependencyInfoKHR,
    ) -> ();
///[Vulkan Manual Page](https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/vkQueueSubmit2KHR.html) · Function
#[allow(non_camel_case_types)]
...
///[Vulkan Manual Page](https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/vkCmdWriteTimestamp2KHR.html) · Function
#[allow(non_camel_case_types)]
...
///[Vulkan Manual Page](https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/vkCmdWriteBufferMarker2AMD.html) · Function
#[allow(non_camel_case_types)]
...
///[Vulkan Manual Page](https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/vkGetQueueCheckpointData2NV.html) · Function
#[allow(non_camel_case_types)]
...
impl<'a> crate::ExtendableFrom<'a, PhysicalDeviceSynchronization2FeaturesKHR>
for crate::vk1_0::DeviceCreateInfoBuilder<'a> {}
impl<'a> crate::ExtendableFrom<'a, PhysicalDeviceSynchronization2FeaturesKHRBuilder<'_>>
for crate::vk1_0::DeviceCreateInfoBuilder<'a> {}
impl<'a> crate::ExtendableFrom<'a, PhysicalDeviceSynchronization2FeaturesKHR>
...
for crate::vk1_1::QueueFamilyProperties2Builder<'a> {}
impl<'a> crate::ExtendableFrom<'a, MemoryBarrier2KHR>
for crate::vk1_2::SubpassDependency2Builder<'a> {}
impl<'a> crate::ExtendableFrom<'a, MemoryBarrier2KHRBuilder<'_>>
for crate::vk1_2::SubpassDependency2Builder<'a> {}
///[Vulkan Manual Page](https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/VkMemoryBarrier2KHR.html) · Structure
...
impl std::fmt::Debug for MemoryBarrier2KHR {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f
            .debug_struct("MemoryBarrier2KHR")
...
#[derive(Copy, Clone)]
///[Vulkan Manual Page](https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/VkMemoryBarrier2KHR.html) · Builder of [`MemoryBarrier2KHR`]
#[repr(transparent)]
...
///[Vulkan Manual Page](https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/VkImageMemoryBarrier2KHR.html) · Structure
...
impl std::fmt::Debug for ImageMemoryBarrier2KHR {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f
            .debug_struct("ImageMemoryBarrier2KHR")
            .field("s_type", &self.s_type)
            .field("p_next", &self.p_next)
            .field("src_stage_mask", &self.src_stage_mask)
            .field("src_access_mask", &self.src_access_mask)
...
#[derive(Copy, Clone)]
///[Vulkan Manual Page](https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/VkImageMemoryBarrier2KHR.html) · Builder of [`ImageMemoryBarrier2KHR`]
#[repr(transparent)]
...
///[Vulkan Manual Page](https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/VkBufferMemoryBarrier2KHR.html) · Structure
...
impl std::fmt::Debug for BufferMemoryBarrier2KHR {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f
            .debug_struct("BufferMemoryBarrier2KHR")
            .field("s_type", &self.s_type)
            .field("p_next", &self.p_next)
            .field("src_stage_mask", &self.src_stage_mask)
            .field("src_access_mask", &self.src_access_mask)
...
#[derive(Copy, Clone)]
///[Vulkan Manual Page](https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/VkBufferMemoryBarrier2KHR.html) · Builder of [`BufferMemoryBarrier2KHR`]
#[repr(transparent)]
...
///[Vulkan Manual Page](https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/VkDependencyInfoKHR.html) · Structure
...
impl std::fmt::Debug for DependencyInfoKHR {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f
            .debug_struct("DependencyInfoKHR")
            .field("s_type", &self.s_type)
            .field("p_next", &self.p_next)
...
#[derive(Copy, Clone)]
///[Vulkan Manual Page](https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/VkDependencyInfoKHR.html) · Builder of [`DependencyInfoKHR`]
#[repr(transparent)]
...
///[Vulkan Manual Page](https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/VkSemaphoreSubmitInfoKHR.html) · Structure
...
impl std::fmt::Debug for SemaphoreSubmitInfoKHR {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f
            .debug_struct("SemaphoreSubmitInfoKHR")
            .field("s_type", &self.s_type)
            .field("p_next", &self.p_next)
...
#[derive(Copy, Clone)]
///[Vulkan Manual Page](https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/VkSemaphoreSubmitInfoKHR.html) · Builder of [`SemaphoreSubmitInfoKHR`]
#[repr(transparent)]
...
///[Vulkan Manual Page](https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/VkCommandBufferSubmitInfoKHR.html) · Structure
...
impl std::fmt::Debug for CommandBufferSubmitInfoKHR {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f
            .debug_struct("CommandBufferSubmitInfoKHR")
            .field("s_type", &self.s_type)
            .field("p_next", &self.p_next)
...
#[derive(Copy, Clone)]
///[Vulkan Manual Page](https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/VkCommandBufferSubmitInfoKHR.html) · Builder of [`CommandBufferSubmitInfoKHR`]
#[repr(transparent)]
...
///[Vulkan Manual Page](https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/VkSubmitInfo2KHR.html) · Structure
...
#[derive(Copy, Clone)]
///[Vulkan Manual Page](https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/VkSubmitInfo2KHR.html) · Builder of [`SubmitInfo2KHR`]
#[repr(transparent)]
...
impl<'a> SubmitInfo2KHRBuilder<'a> {
    ...
    pub fn flags(
        mut self,
        flags: crate::extensions::khr_synchronization2::SubmitFlagsKHR,
    ) -> Self {
...
///[Vulkan Manual Page](https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/VkQueueFamilyCheckpointProperties2NV.html) · Structure
...
impl std::fmt::Debug for QueueFamilyCheckpointProperties2NV {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f
            .debug_struct("QueueFamilyCheckpointProperties2NV")
            .field("s_type", &self.s_type)
            .field("p_next", &self.p_next)
            .field(
...
#[derive(Copy, Clone)]
///[Vulkan Manual Page](https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/VkQueueFamilyCheckpointProperties2NV.html) · Builder of [`QueueFamilyCheckpointProperties2NV`]
#[repr(transparent)]
...
///[Vulkan Manual Page](https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/VkCheckpointData2NV.html) · Structure
...
impl std::fmt::Debug for CheckpointData2NV {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f
            .debug_struct("CheckpointData2NV")
            .field("s_type", &self.s_type)
            .field("p_next", &self.p_next)
...
#[derive(Copy, Clone)]
///[Vulkan Manual Page](https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/VkCheckpointData2NV.html) · Builder of [`CheckpointData2NV`]
#[repr(transparent)]
...
///[Vulkan Manual Page](https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/VkPhysicalDeviceSynchronization2FeaturesKHR.html) · Structure
...
impl std::fmt::Debug for PhysicalDeviceSynchronization2FeaturesKHR {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f
            .debug_struct("PhysicalDeviceSynchronization2FeaturesKHR")
            .field("s_type", &self.s_type)
            .field("p_next", &self.p_next)
...
impl PhysicalDeviceSynchronization2FeaturesKHR {
    ...
    pub fn into_builder<'a>(
        self,
    ) -> PhysicalDeviceSynchronization2FeaturesKHRBuilder<'a> {
        PhysicalDeviceSynchronization2FeaturesKHRBuilder(self, std::marker::PhantomData)
    }
}
#[derive(Copy, Clone)]
///[Vulkan Manual Page](https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/VkPhysicalDeviceSynchronization2FeaturesKHR.html) · Builder of [`PhysicalDeviceSynchronization2FeaturesKHR`]
#[repr(transparent)]
