...
bitflags::bitflags! { # [doc = "[Vulkan Manual Page](https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/VkAccessFlags2KHR.html) · Bitmask of [`AccessFlagBits2KHR`]"] # [doc (alias = "VkAccessFlags2KHR")] # [derive (Default)] # [repr (transparent)] pub struct AccessFlags2KHR : u64 { # [cfg (feature = "khr_synchronization2")] const NONE_KHR = AccessFlagBits2KHR :: NONE_KHR . 0 ; # [cfg (feature = "khr_synchronization2")] const INDIRECT_COMMAND_READ_KHR = AccessFlagBits2KHR :: INDIRECT_COMMAND_READ_KHR . 0 ; # [cfg (feature = "khr_synchronization2")] const INDEX_READ_KHR = AccessFlagBits2KHR :: INDEX_READ_KHR . 0 ; # [cfg (feature = "khr_synchronization2")] const VERTEX_ATTRIBUTE_READ_KHR = AccessFlagBits2KHR :: VERTEX_ATTRIBUTE_READ_KHR . 0 ; # [cfg (feature = "khr_synchronization2")] const UNIFORM_READ_KHR = AccessFlagBits2KHR :: UNIFORM_READ_KHR . 0 ; # [cfg (feature = "khr_synchronization2")] const INPUT_ATTACHMENT_READ_KHR = AccessFlagBits2KHR :: INPUT_ATTACHMENT_READ_KHR . 0 ; # [cfg (feature = "khr_synchronization2")] const SHADER_READ_KHR = AccessFlagBits2KHR :: SHADER_READ_KHR . 0 ; # [cfg (feature = "khr_synchronization2")] const SHADER_WRITE_KHR = AccessFlagBits2KHR :: SHADER_WRITE_KHR . 0 ; # [cfg (feature = "khr_synchronization2")] const COLOR_ATTACHMENT_READ_KHR = AccessFlagBits2KHR :: COLOR_ATTACHMENT_READ_KHR . 0 ; # [cfg (feature = "khr_synchronization2")] const COLOR_ATTACHMENT_WRITE_KHR = AccessFlagBits2KHR :: COLOR_ATTACHMENT_WRITE_KHR . 0 ; # [cfg (feature = "khr_synchronization2")] const DEPTH_STENCIL_ATTACHMENT_READ_KHR = AccessFlagBits2KHR :: DEPTH_STENCIL_ATTACHMENT_READ_KHR . 0 ; # [cfg (feature = "khr_synchronization2")] const DEPTH_STENCIL_ATTACHMENT_WRITE_KHR = AccessFlagBits2KHR :: DEPTH_STENCIL_ATTACHMENT_WRITE_KHR . 0 ; # [cfg (feature = "khr_synchronization2")] const TRANSFER_READ_KHR = AccessFlagBits2KHR :: TRANSFER_READ_KHR . 0 ; # [cfg (feature = "khr_synchronization2")] const TRANSFER_WRITE_KHR = AccessFlagBits2KHR :: TRANSFER_WRITE_KHR . 0 ; # [cfg (feature = "khr_synchronization2")] const HOST_READ_KHR = AccessFlagBits2KHR :: HOST_READ_KHR . 0 ; # [cfg (feature = "khr_synchronization2")] const HOST_WRITE_KHR = AccessFlagBits2KHR :: HOST_WRITE_KHR . 0 ; # [cfg (feature = "khr_synchronization2")] const MEMORY_READ_KHR = AccessFlagBits2KHR :: MEMORY_READ_KHR . 0 ; # [cfg (feature = "khr_synchronization2")] const MEMORY_WRITE_KHR = AccessFlagBits2KHR :: MEMORY_WRITE_KHR . 0 ; # [cfg (feature = "khr_synchronization2")] const SHADER_SAMPLED_READ_KHR = AccessFlagBits2KHR :: SHADER_SAMPLED_READ_KHR . 0 ; # [cfg (feature = "khr_synchronization2")] const SHADER_STORAGE_READ_KHR = AccessFlagBits2KHR :: SHADER_STORAGE_READ_KHR . 0 ; # [cfg (feature = "khr_synchronization2")] const SHADER_STORAGE_WRITE_KHR = AccessFlagBits2KHR :: SHADER_STORAGE_WRITE_KHR . 0 ; # [cfg (feature = "khr_video_decode_queue")] const VIDEO_DECODE_READ_KHR = AccessFlagBits2KHR :: VIDEO_DECODE_READ_KHR . 0 ; # [cfg (feature = "khr_video_decode_queue")] const VIDEO_DECODE_WRITE_KHR = AccessFlagBits2KHR :: VIDEO_DECODE_WRITE_KHR . 0 ; # [cfg (feature = "khr_video_encode_queue")] const VIDEO_ENCODE_READ_KHR = AccessFlagBits2KHR :: VIDEO_ENCODE_READ_KHR . 0 ; # [cfg (feature = "khr_video_encode_queue")] const VIDEO_ENCODE_WRITE_KHR = AccessFlagBits2KHR :: VIDEO_ENCODE_WRITE_KHR . 0 ; # [cfg (feature = "khr_synchronization2")] const TRANSFORM_FEEDBACK_WRITE_EXT = AccessFlagBits2KHR :: TRANSFORM_FEEDBACK_WRITE_EXT . 0 ; # [cfg (feature = "khr_synchronization2")] const TRANSFORM_FEEDBACK_COUNTER_READ_EXT = AccessFlagBits2KHR :: TRANSFORM_FEEDBACK_COUNTER_READ_EXT . 0 ; # [cfg (feature = "khr_synchronization2")] const TRANSFORM_FEEDBACK_COUNTER_WRITE_EXT = AccessFlagBits2KHR :: TRANSFORM_FEEDBACK_COUNTER_WRITE_EXT . 0 ; # [cfg (feature = "khr_synchronization2")] const CONDITIONAL_RENDERING_READ_EXT = AccessFlagBits2KHR :: CONDITIONAL_RENDERING_READ_EXT . 0 ; # [cfg (feature = "khr_synchronization2")] const COMMAND_PREPROCESS_READ_NV = AccessFlagBits2KHR :: COMMAND_PREPROCESS_READ_NV . 0 ; # [cfg (feature = "khr_synchronization2")] const COMMAND_PREPROCESS_WRITE_NV = AccessFlagBits2KHR :: COMMAND_PREPROCESS_WRITE_NV . 0 ; # [cfg (feature = "khr_synchronization2")] const FRAGMENT_SHADING_RATE_ATTACHMENT_READ_KHR = AccessFlagBits2KHR :: FRAGMENT_SHADING_RATE_ATTACHMENT_READ_KHR . 0 ; # [cfg (feature = "khr_synchronization2")] const SHADING_RATE_IMAGE_READ_NV = AccessFlagBits2KHR :: SHADING_RATE_IMAGE_READ_NV . 0 ; # [cfg (feature = "khr_synchronization2")] const ACCELERATION_STRUCTURE_READ_KHR = AccessFlagBits2KHR :: ACCELERATION_STRUCTURE_READ_KHR . 0 ; # [cfg (feature = "khr_synchronization2")] const ACCELERATION_STRUCTURE_WRITE_KHR = AccessFlagBits2KHR :: ACCELERATION_STRUCTURE_WRITE_KHR . 0 ; # [cfg (feature = "khr_synchronization2")] const ACCELERATION_STRUCTURE_READ_NV = AccessFlagBits2KHR :: ACCELERATION_STRUCTURE_READ_NV . 0 ; # [cfg (feature = "khr_synchronization2")] const ACCELERATION_STRUCTURE_WRITE_NV = AccessFlagBits2KHR :: ACCELERATION_STRUCTURE_WRITE_NV . 0 ; # [cfg (feature = "khr_synchronization2")] const FRAGMENT_DENSITY_MAP_READ_EXT = AccessFlagBits2KHR :: FRAGMENT_DENSITY_MAP_READ_EXT . 0 ; # [cfg (feature = "khr_synchronization2")] const COLOR_ATTACHMENT_READ_NONCOHERENT_EXT = AccessFlagBits2KHR :: COLOR_ATTACHMENT_READ_NONCOHERENT_EXT . 0 ; } }
...
bitflags::bitflags! { # [doc = "[Vulkan Manual Page](https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/VkPipelineStageFlags2KHR.html) · Bitmask of [`PipelineStageFlagBits2KHR`]"] # [doc (alias = "VkPipelineStageFlags2KHR")] # [derive (Default)] # [repr (transparent)] pub struct PipelineStageFlags2KHR : u64 { # [cfg (feature = "khr_synchronization2")] const NONE_KHR = PipelineStageFlagBits2KHR :: NONE_KHR . 0 ; # [cfg (feature = "khr_synchronization2")] const TOP_OF_PIPE_KHR = PipelineStageFlagBits2KHR :: TOP_OF_PIPE_KHR . 0 ; # [cfg (feature = "khr_synchronization2")] const DRAW_INDIRECT_KHR = PipelineStageFlagBits2KHR :: DRAW_INDIRECT_KHR . 0 ; # [cfg (feature = "khr_synchronization2")] const VERTEX_INPUT_KHR = PipelineStageFlagBits2KHR :: VERTEX_INPUT_KHR . 0 ; # [cfg (feature = "khr_synchronization2")] const VERTEX_SHADER_KHR = PipelineStageFlagBits2KHR :: VERTEX_SHADER_KHR . 0 ; # [cfg (feature = "khr_synchronization2")] const TESSELLATION_CONTROL_SHADER_KHR = PipelineStageFlagBits2KHR :: TESSELLATION_CONTROL_SHADER_KHR . 0 ; # [cfg (feature = "khr_synchronization2")] const TESSELLATION_EVALUATION_SHADER_KHR = PipelineStageFlagBits2KHR :: TESSELLATION_EVALUATION_SHADER_KHR . 0 ; # [cfg (feature = "khr_synchronization2")] const GEOMETRY_SHADER_KHR = PipelineStageFlagBits2KHR :: GEOMETRY_SHADER_KHR . 0 ; # [cfg (feature = "khr_synchronization2")] const FRAGMENT_SHADER_KHR = PipelineStageFlagBits2KHR :: FRAGMENT_SHADER_KHR . 0 ; # [cfg (feature = "khr_synchronization2")] const EARLY_FRAGMENT_TESTS_KHR = PipelineStageFlagBits2KHR :: EARLY_FRAGMENT_TESTS_KHR . 0 ; # [cfg (feature = "khr_synchronization2")] const LATE_FRAGMENT_TESTS_KHR = PipelineStageFlagBits2KHR :: LATE_FRAGMENT_TESTS_KHR . 0 ; # [cfg (feature = "khr_synchronization2")] const COLOR_ATTACHMENT_OUTPUT_KHR = PipelineStageFlagBits2KHR :: COLOR_ATTACHMENT_OUTPUT_KHR . 0 ; # [cfg (feature = "khr_synchronization2")] const COMPUTE_SHADER_KHR = PipelineStageFlagBits2KHR :: COMPUTE_SHADER_KHR . 0 ; # [cfg (feature = "khr_synchronization2")] const ALL_TRANSFER_KHR = PipelineStageFlagBits2KHR :: ALL_TRANSFER_KHR . 0 ; # [cfg (feature = "khr_synchronization2")] const TRANSFER_KHR = PipelineStageFlagBits2KHR :: TRANSFER_KHR . 0 ; # [cfg (feature = "khr_synchronization2")] const BOTTOM_OF_PIPE_KHR = PipelineStageFlagBits2KHR :: BOTTOM_OF_PIPE_KHR . 0 ; # [cfg (feature = "khr_synchronization2")] const HOST_KHR = PipelineStageFlagBits2KHR :: HOST_KHR . 0 ; # [cfg (feature = "khr_synchronization2")] const ALL_GRAPHICS_KHR = PipelineStageFlagBits2KHR :: ALL_GRAPHICS_KHR . 0 ; # [cfg (feature = "khr_synchronization2")] const ALL_COMMANDS_KHR = PipelineStageFlagBits2KHR :: ALL_COMMANDS_KHR . 0 ; # [cfg (feature = "khr_synchronization2")] const COPY_KHR = PipelineStageFlagBits2KHR :: COPY_KHR . 0 ; # [cfg (feature = "khr_synchronization2")] const RESOLVE_KHR = PipelineStageFlagBits2KHR :: RESOLVE_KHR . 0 ; # [cfg (feature = "khr_synchronization2")] const BLIT_KHR = PipelineStageFlagBits2KHR :: BLIT_KHR . 0 ; # [cfg (feature = "khr_synchronization2")] const CLEAR_KHR = PipelineStageFlagBits2KHR :: CLEAR_KHR . 0 ; # [cfg (feature = "khr_synchronization2")] const INDEX_INPUT_KHR = PipelineStageFlagBits2KHR :: INDEX_INPUT_KHR . 0 ; # [cfg (feature = "khr_synchronization2")] const VERTEX_ATTRIBUTE_INPUT_KHR = PipelineStageFlagBits2KHR :: VERTEX_ATTRIBUTE_INPUT_KHR . 0 ; # [cfg (feature = "khr_synchronization2")] const PRE_RASTERIZATION_SHADERS_KHR = PipelineStageFlagBits2KHR :: PRE_RASTERIZATION_SHADERS_KHR . 0 ; # [cfg (feature = "khr_video_decode_queue")] const VIDEO_DECODE_KHR = PipelineStageFlagBits2KHR :: VIDEO_DECODE_KHR . 0 ; # [cfg (feature = "khr_video_encode_queue")] const VIDEO_ENCODE_KHR = PipelineStageFlagBits2KHR :: VIDEO_ENCODE_KHR . 0 ; # [cfg (feature = "khr_synchronization2")] const TRANSFORM_FEEDBACK_EXT = PipelineStageFlagBits2KHR :: TRANSFORM_FEEDBACK_EXT . 0 ; # [cfg (feature = "khr_synchronization2")] const CONDITIONAL_RENDERING_EXT = PipelineStageFlagBits2KHR :: CONDITIONAL_RENDERING_EXT . 0 ; # [cfg (feature = "khr_synchronization2")] const COMMAND_PREPROCESS_NV = PipelineStageFlagBits2KHR :: COMMAND_PREPROCESS_NV . 0 ; # [cfg (feature = "khr_synchronization2")] const FRAGMENT_SHADING_RATE_ATTACHMENT_KHR = PipelineStageFlagBits2KHR :: FRAGMENT_SHADING_RATE_ATTACHMENT_KHR . 0 ; # [cfg (feature = "khr_synchronization2")] const SHADING_RATE_IMAGE_NV = PipelineStageFlagBits2KHR :: SHADING_RATE_IMAGE_NV . 0 ; # [cfg (feature = "khr_synchronization2")] const ACCELERATION_STRUCTURE_BUILD_KHR = PipelineStageFlagBits2KHR :: ACCELERATION_STRUCTURE_BUILD_KHR . 0 ; # [cfg (feature = "khr_synchronization2")] const RAY_TRACING_SHADER_KHR = PipelineStageFlagBits2KHR :: RAY_TRACING_SHADER_KHR . 0 ; # [cfg (feature = "khr_synchronization2")] const RAY_TRACING_SHADER_NV = PipelineStageFlagBits2KHR :: RAY_TRACING_SHADER_NV . 0 ; # [cfg (feature = "khr_synchronization2")] const ACCELERATION_STRUCTURE_BUILD_NV = PipelineStageFlagBits2KHR :: ACCELERATION_STRUCTURE_BUILD_NV . 0 ; # [cfg (feature = "khr_synchronization2")] const FRAGMENT_DENSITY_PROCESS_EXT = PipelineStageFlagBits2KHR :: FRAGMENT_DENSITY_PROCESS_EXT . 0 ; # [cfg (feature = "khr_synchronization2")] const TASK_SHADER_NV = PipelineStageFlagBits2KHR :: TASK_SHADER_NV . 0 ; # [cfg (feature = "khr_synchronization2")] const MESH_SHADER_NV = PipelineStageFlagBits2KHR :: MESH_SHADER_NV . 0 ; } }
...
bitflags::bitflags! { # [doc = "[Vulkan Manual Page](https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/VkSubmitFlagsKHR.html) · Bitmask of [`SubmitFlagBitsKHR`]"] # [doc (alias = "VkSubmitFlagsKHR")] # [derive (Default)] # [repr (transparent)] pub struct SubmitFlagsKHR : u32 { # [cfg (feature = "khr_synchronization2")] const PROTECTED_KHR = SubmitFlagBitsKHR :: PROTECTED_KHR . 0 ; } }
...
#[allow(non_camel_case_types)]
pub type PFN_vkCmdWaitEvents2KHR = unsafe extern "system" fn(command_buffer: crate::vk1_0::CommandBuffer, event_count: u32, p_events: *const crate::vk1_0::Event, p_dependency_infos: *const crate::extensions::khr_synchronization2::DependencyInfoKHR) -> ();
...
#[allow(non_camel_case_types)]
pub type PFN_vkCmdWriteBufferMarker2AMD = unsafe extern "system" fn(command_buffer: crate::vk1_0::CommandBuffer, stage: crate::extensions::khr_synchronization2::PipelineStageFlags2KHR, dst_buffer: crate::vk1_0::Buffer, dst_offset: crate::vk1_0::DeviceSize, marker: u32) -> ();
...
impl std::fmt::Debug for MemoryBarrier2KHR {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct("MemoryBarrier2KHR").field("s_type", &self.s_type).field("p_next", &self.p_next).field("src_stage_mask", &self.src_stage_mask).field("src_access_mask", &self.src_access_mask).field("dst_stage_mask", &self.dst_stage_mask).field("dst_access_mask", &self.dst_access_mask).finish()
    }
}
...
impl std::fmt::Debug for ImageMemoryBarrier2KHR {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct("ImageMemoryBarrier2KHR").field("s_type", &self.s_type).field("p_next", &self.p_next).field("src_stage_mask", &self.src_stage_mask).field("src_access_mask", &self.src_access_mask).field("dst_stage_mask", &self.dst_stage_mask).field("dst_access_mask", &self.dst_access_mask).field("old_layout", &self.old_layout).field("new_layout", &self.new_layout).field("src_queue_family_index", &self.src_queue_family_index).field("dst_queue_family_index", &self.dst_queue_family_index).field("image", &self.image).field("subresource_range", &self.subresource_range).finish()
    }
}
...
impl std::fmt::Debug for BufferMemoryBarrier2KHR {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct("BufferMemoryBarrier2KHR").field("s_type", &self.s_type).field("p_next", &self.p_next).field("src_stage_mask", &self.src_stage_mask).field("src_access_mask", &self.src_access_mask).field("dst_stage_mask", &self.dst_stage_mask).field("dst_access_mask", &self.dst_access_mask).field("src_queue_family_index", &self.src_queue_family_index).field("dst_queue_family_index", &self.dst_queue_family_index).field("buffer", &self.buffer).field("offset", &self.offset).field("size", &self.size).finish()
    }
}
...
impl std::fmt::Debug for DependencyInfoKHR {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct("DependencyInfoKHR").field("s_type", &self.s_type).field("p_next", &self.p_next).field("dependency_flags", &self.dependency_flags).field("memory_barrier_count", &self.memory_barrier_count).field("p_memory_barriers", &self.p_memory_barriers).field("buffer_memory_barrier_count", &self.buffer_memory_barrier_count).field("p_buffer_memory_barriers", &self.p_buffer_memory_barriers).field("image_memory_barrier_count", &self.image_memory_barrier_count).field("p_image_memory_barriers", &self.p_image_memory_barriers).finish()
    }
}
...
impl std::fmt::Debug for SemaphoreSubmitInfoKHR {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct("SemaphoreSubmitInfoKHR").field("s_type", &self.s_type).field("p_next", &self.p_next).field("semaphore", &self.semaphore).field("value", &self.value).field("stage_mask", &self.stage_mask).field("device_index", &self.device_index).finish()
    }
}
...
impl std::fmt::Debug for CommandBufferSubmitInfoKHR {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct("CommandBufferSubmitInfoKHR").field("s_type", &self.s_type).field("p_next", &self.p_next).field("command_buffer", &self.command_buffer).field("device_mask", &self.device_mask).finish()
    }
}
...
impl std::fmt::Debug for SubmitInfo2KHR {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct("SubmitInfo2KHR").field("s_type", &self.s_type).field("p_next", &self.p_next).field("flags", &self.flags).field("wait_semaphore_info_count", &self.wait_semaphore_info_count).field("p_wait_semaphore_infos", &self.p_wait_semaphore_infos).field("command_buffer_info_count", &self.command_buffer_info_count).field("p_command_buffer_infos", &self.p_command_buffer_infos).field("signal_semaphore_info_count", &self.signal_semaphore_info_count).field("p_signal_semaphore_infos", &self.p_signal_semaphore_infos).finish()
    }
}
impl SubmitInfo2KHR {
    #[inline]
...
impl std::fmt::Debug for QueueFamilyCheckpointProperties2NV {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct("QueueFamilyCheckpointProperties2NV").field("s_type", &self.s_type).field("p_next", &self.p_next).field("checkpoint_execution_stage_mask", &self.checkpoint_execution_stage_mask).finish()
    }
}
...
impl std::fmt::Debug for CheckpointData2NV {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct("CheckpointData2NV").field("s_type", &self.s_type).field("p_next", &self.p_next).field("stage", &self.stage).field("p_checkpoint_marker", &self.p_checkpoint_marker).finish()
    }
}
...
impl std::fmt::Debug for PhysicalDeviceSynchronization2FeaturesKHR {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct("PhysicalDeviceSynchronization2FeaturesKHR").field("s_type", &self.s_type).field("p_next", &self.p_next).field("synchronization2", &(self.synchronization2 != 0)).finish()
    }
}
