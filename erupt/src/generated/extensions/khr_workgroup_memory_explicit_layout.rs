...
pub const KHR_WORKGROUP_MEMORY_EXPLICIT_LAYOUT_EXTENSION_NAME: *const std::os::raw::c_char =
    ...
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct("PhysicalDeviceWorkgroupMemoryExplicitLayoutFeaturesKHR")
            ...
            .field(
                ...
                &(self.workgroup_memory_explicit_layout != 0),
            )
            .field(
            ...
            .field(
                ...
                &(self.workgroup_memory_explicit_layout8_bit_access != 0),
            )
            .field(
                "workgroup_memory_explicit_layout16_bit_access",
                &(self.workgroup_memory_explicit_layout16_bit_access != 0),
            )
            .finish()
    }
}
...
impl<'a> PhysicalDeviceWorkgroupMemoryExplicitLayoutFeaturesKHRBuilder<'a> {
    ...
    pub fn workgroup_memory_explicit_layout_scalar_block_layout(
        ...
        self.0.workgroup_memory_explicit_layout_scalar_block_layout =
            workgroup_memory_explicit_layout_scalar_block_layout as _;
        self
    }
    #[inline]
    pub fn workgroup_memory_explicit_layout8_bit_access(
        ...
        self.0.workgroup_memory_explicit_layout8_bit_access =
            workgroup_memory_explicit_layout8_bit_access as _;
        self
    }
    #[inline]
    pub fn workgroup_memory_explicit_layout16_bit_access(
        ...
        self.0.workgroup_memory_explicit_layout16_bit_access =
            workgroup_memory_explicit_layout16_bit_access as _;
        self
    }
    #[inline]
