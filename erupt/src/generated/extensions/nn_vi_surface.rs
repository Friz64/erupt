...
pub const NN_VI_SURFACE_EXTENSION_NAME: *const std::os::raw::c_char = crate::cstr!(
    "VK_NN_vi_surface"
);
///<s>Vulkan Manual Page</s> · Constant
pub const FN_CREATE_VI_SURFACE_NN: *const std::os::raw::c_char = crate::cstr!(
    "vkCreateViSurfaceNN"
);
bitflags::bitflags! {
    #[doc =
...
///<s>Vulkan Manual Page</s> · Bits enum of [`ViSurfaceCreateFlagsNN`]
...
impl std::fmt::Debug for ViSurfaceCreateInfoNN {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f
            .debug_struct("ViSurfaceCreateInfoNN")
