...
pub const NV_COVERAGE_REDUCTION_MODE_EXTENSION_NAME: *const std::os::raw::c_char = crate::cstr!(
    "VK_NV_coverage_reduction_mode"
);
///<s>Vulkan Manual Page</s> · Constant
pub const FN_GET_PHYSICAL_DEVICE_SUPPORTED_FRAMEBUFFER_MIXED_SAMPLES_COMBINATIONS_NV: *const std::os::raw::c_char = crate::cstr!(
...
///<s>Vulkan Manual Page</s> · Bits enum of [`PipelineCoverageReductionStateCreateFlagsNV`]
...
for crate::vk1_0::DeviceCreateInfoBuilder<'a> {}
impl<'a> crate::ExtendableFrom<'a, PipelineCoverageReductionStateCreateInfoNV>
for crate::vk1_0::PipelineMultisampleStateCreateInfoBuilder<'a> {}
impl<'a> crate::ExtendableFrom<'a, PipelineCoverageReductionStateCreateInfoNVBuilder<'_>>
for crate::vk1_0::PipelineMultisampleStateCreateInfoBuilder<'a> {}
impl<'a> crate::ExtendableFrom<'a, PhysicalDeviceCoverageReductionModeFeaturesNV>
...
impl<'a> std::default::Default
for PipelineCoverageReductionStateCreateInfoNVBuilder<'a> {
...
impl<'a> FramebufferMixedSamplesCombinationNVBuilder<'a> {
    ...
    pub fn color_samples(
        mut self,
        color_samples: crate::vk1_0::SampleCountFlags,
    ) -> Self {
...
impl crate::InstanceLoader {
    ...
    pub unsafe fn get_physical_device_supported_framebuffer_mixed_samples_combinations_nv(
        ...
        combinations_callback: impl FnMut(
            &mut crate::SmallVec<
                crate::extensions::nv_coverage_reduction_mode::FramebufferMixedSamplesCombinationNV,
            >,
        ) -> (),
        ...
        let mut combinations = crate::SmallVec::from_elem(
            Default::default(),
            combination_count as _,
        );
