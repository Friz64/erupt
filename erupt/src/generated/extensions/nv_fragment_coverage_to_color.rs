...
pub const NV_FRAGMENT_COVERAGE_TO_COLOR_EXTENSION_NAME: *const std::os::raw::c_char = crate::cstr!(
...
///<s>Vulkan Manual Page</s> · Bits enum of [`PipelineCoverageToColorStateCreateFlagsNV`]
...
impl<'a> crate::ExtendableFrom<'a, PipelineCoverageToColorStateCreateInfoNV>
