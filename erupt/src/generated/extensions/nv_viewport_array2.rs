...
pub const NV_VIEWPORT_ARRAY_2_EXTENSION_NAME: *const std::os::raw::c_char = crate::cstr!(
...
pub const NV_VIEWPORT_ARRAY2_EXTENSION_NAME: *const std::os::raw::c_char = crate::cstr!(
    "VK_NV_viewport_array2"
);
