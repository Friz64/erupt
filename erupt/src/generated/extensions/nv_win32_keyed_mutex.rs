...
pub const NV_WIN32_KEYED_MUTEX_EXTENSION_NAME: *const std::os::raw::c_char = crate::cstr!(
    "VK_NV_win32_keyed_mutex"
);
///Provided by [`crate::extensions::nv_win32_keyed_mutex`]
impl crate::vk1_0::StructureType {
    pub const WIN32_KEYED_MUTEX_ACQUIRE_RELEASE_INFO_NV: Self = Self(1000058000);
}
impl<'a> crate::ExtendableFrom<'a, Win32KeyedMutexAcquireReleaseInfoNV>
for crate::vk1_0::SubmitInfoBuilder<'a> {}
impl<'a> crate::ExtendableFrom<'a, Win32KeyedMutexAcquireReleaseInfoNVBuilder<'_>>
for crate::vk1_0::SubmitInfoBuilder<'a> {}
///[Vulkan Manual Page](https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/VkWin32KeyedMutexAcquireReleaseInfoNV.html) · Structure
...
impl std::fmt::Debug for Win32KeyedMutexAcquireReleaseInfoNV {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f
            .debug_struct("Win32KeyedMutexAcquireReleaseInfoNV")
...
#[derive(Copy, Clone)]
///[Vulkan Manual Page](https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/VkWin32KeyedMutexAcquireReleaseInfoNV.html) · Builder of [`Win32KeyedMutexAcquireReleaseInfoNV`]
#[repr(transparent)]
...
impl<'a> Win32KeyedMutexAcquireReleaseInfoNVBuilder<'a> {
    ...
    pub fn acquire_syncs(
        mut self,
        acquire_syncs: &'a [crate::vk1_0::DeviceMemory],
    ) -> Self {
    ...
    pub fn acquire_timeout_milliseconds(
        ...
        self
            .0
            .p_acquire_timeout_milliseconds = acquire_timeout_milliseconds.as_ptr() as _;
    ...
    pub fn release_syncs(
        mut self,
        release_syncs: &'a [crate::vk1_0::DeviceMemory],
    ) -> Self {
