# ! [ doc = "[Vulkan Manual Page](https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/VK_NV_win32_keyed_mutex.html)\n\n## Extends\n- [`StructureType`](../../vk1_0/struct.StructureType.html)" ]#[doc = "<s>Vulkan Manual Page</s> · Constant"]
...
impl Win32KeyedMutexAcquireReleaseInfoNV {
    ...
    #[inline]
    pub fn builder<'a>(self) -> Win32KeyedMutexAcquireReleaseInfoNVBuilder<'a> {
...
#[derive(Copy, Clone)]
#[doc = "[Vulkan Manual Page](https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/VkWin32KeyedMutexAcquireReleaseInfoNV.html) · Builder of [`Win32KeyedMutexAcquireReleaseInfoNV`](struct.Win32KeyedMutexAcquireReleaseInfoNV.html)"]
#[repr(transparent)]
...
impl<'a> Win32KeyedMutexAcquireReleaseInfoNVBuilder<'a> {
    ...
    pub unsafe fn discard(self) -> Win32KeyedMutexAcquireReleaseInfoNV {
        self.0
    }
}
