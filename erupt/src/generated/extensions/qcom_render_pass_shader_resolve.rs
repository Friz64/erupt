...
pub const QCOM_RENDER_PASS_SHADER_RESOLVE_EXTENSION_NAME: *const std::os::raw::c_char = crate::cstr!("VK_QCOM_render_pass_shader_resolve");
#[doc = "Provided by [`crate::extensions::qcom_render_pass_shader_resolve`]"]
