...
impl DeviceLoader {
    ...
    pub fn new(
        ...
        Some(DeviceLoader {
            ...
            ext_extended_dynamic_state: None,
    ...
    #[inline]
    #[must_use = "Loading may have not been successful"]
    pub fn load_ext_extended_dynamic_state(&mut self) -> Option<()> {
        self . ext_extended_dynamic_state = crate :: extensions :: ext_extended_dynamic_state :: ExtExtendedDynamicStateDeviceCommands :: load ( & self ) ;
        self.ext_extended_dynamic_state.as_ref().map(|_| ())
    }
    #[inline]
    #[must_use = "Loading may have not been successful"]
