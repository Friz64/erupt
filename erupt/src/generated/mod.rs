...
impl InstanceEnabled {
    pub unsafe fn new(instance_version: u32, enabled_extensions: &[&std::ffi::CStr], available_device_extensions: &[&std::ffi::CStr]) -> Result<InstanceEnabled, crate::LoaderError> {
        ...
        Ok(InstanceEnabled {
            vk1_1: version >= crate::vk1_0::make_version(1, 1, 0),
            vk1_2: version >= crate::vk1_0::make_version(1, 2, 0),
            khr_android_surface: enabled_extension(crate::extensions::khr_android_surface::KHR_ANDROID_SURFACE_EXTENSION_NAME),
            khr_display: enabled_extension(crate::extensions::khr_display::KHR_DISPLAY_EXTENSION_NAME),
            khr_surface: enabled_extension(crate::extensions::khr_surface::KHR_SURFACE_EXTENSION_NAME),
            nn_vi_surface: enabled_extension(crate::extensions::nn_vi_surface::NN_VI_SURFACE_EXTENSION_NAME),
            khr_wayland_surface: enabled_extension(crate::extensions::khr_wayland_surface::KHR_WAYLAND_SURFACE_EXTENSION_NAME),
            khr_win32_surface: enabled_extension(crate::extensions::khr_win32_surface::KHR_WIN32_SURFACE_EXTENSION_NAME),
            khr_xlib_surface: enabled_extension(crate::extensions::khr_xlib_surface::KHR_XLIB_SURFACE_EXTENSION_NAME),
            khr_xcb_surface: enabled_extension(crate::extensions::khr_xcb_surface::KHR_XCB_SURFACE_EXTENSION_NAME),
            ext_directfb_surface: enabled_extension(crate::extensions::ext_directfb_surface::EXT_DIRECTFB_SURFACE_EXTENSION_NAME),
            fuchsia_imagepipe_surface: enabled_extension(crate::extensions::fuchsia_imagepipe_surface::FUCHSIA_IMAGEPIPE_SURFACE_EXTENSION_NAME),
            ggp_stream_descriptor_surface: enabled_extension(crate::extensions::ggp_stream_descriptor_surface::GGP_STREAM_DESCRIPTOR_SURFACE_EXTENSION_NAME),
            qnx_screen_surface: enabled_extension(crate::extensions::qnx_screen_surface::QNX_SCREEN_SURFACE_EXTENSION_NAME),
            ext_debug_report: enabled_extension(crate::extensions::ext_debug_report::EXT_DEBUG_REPORT_EXTENSION_NAME),
            nv_external_memory_capabilities: enabled_extension(crate::extensions::nv_external_memory_capabilities::NV_EXTERNAL_MEMORY_CAPABILITIES_EXTENSION_NAME),
            ext_direct_mode_display: enabled_extension(crate::extensions::ext_direct_mode_display::EXT_DIRECT_MODE_DISPLAY_EXTENSION_NAME),
            ext_acquire_xlib_display: enabled_extension(crate::extensions::ext_acquire_xlib_display::EXT_ACQUIRE_XLIB_DISPLAY_EXTENSION_NAME),
            nv_acquire_winrt_display: available_device_extension(crate::extensions::nv_acquire_winrt_display::NV_ACQUIRE_WINRT_DISPLAY_EXTENSION_NAME),
            ext_display_surface_counter: enabled_extension(crate::extensions::ext_display_surface_counter::EXT_DISPLAY_SURFACE_COUNTER_EXTENSION_NAME),
            khr_swapchain: available_device_extension(crate::extensions::khr_swapchain::KHR_SWAPCHAIN_EXTENSION_NAME),
            khr_device_group: available_device_extension(crate::extensions::khr_device_group::KHR_DEVICE_GROUP_EXTENSION_NAME),
            mvk_ios_surface: enabled_extension(crate::extensions::mvk_ios_surface::MVK_IOS_SURFACE_EXTENSION_NAME),
            mvk_macos_surface: enabled_extension(crate::extensions::mvk_macos_surface::MVK_MACOS_SURFACE_EXTENSION_NAME),
            ext_metal_surface: enabled_extension(crate::extensions::ext_metal_surface::EXT_METAL_SURFACE_EXTENSION_NAME),
            ext_sample_locations: available_device_extension(crate::extensions::ext_sample_locations::EXT_SAMPLE_LOCATIONS_EXTENSION_NAME),
            khr_get_surface_capabilities2: enabled_extension(crate::extensions::khr_get_surface_capabilities2::KHR_GET_SURFACE_CAPABILITIES_2_EXTENSION_NAME),
            khr_get_display_properties2: enabled_extension(crate::extensions::khr_get_display_properties2::KHR_GET_DISPLAY_PROPERTIES_2_EXTENSION_NAME),
            ext_calibrated_timestamps: available_device_extension(crate::extensions::ext_calibrated_timestamps::EXT_CALIBRATED_TIMESTAMPS_EXTENSION_NAME),
            ext_debug_utils: enabled_extension(crate::extensions::ext_debug_utils::EXT_DEBUG_UTILS_EXTENSION_NAME),
            nv_cooperative_matrix: available_device_extension(crate::extensions::nv_cooperative_matrix::NV_COOPERATIVE_MATRIX_EXTENSION_NAME),
            ext_full_screen_exclusive: available_device_extension(crate::extensions::ext_full_screen_exclusive::EXT_FULL_SCREEN_EXCLUSIVE_EXTENSION_NAME),
            khr_performance_query: available_device_extension(crate::extensions::khr_performance_query::KHR_PERFORMANCE_QUERY_EXTENSION_NAME),
            ext_headless_surface: enabled_extension(crate::extensions::ext_headless_surface::EXT_HEADLESS_SURFACE_EXTENSION_NAME),
            nv_coverage_reduction_mode: available_device_extension(crate::extensions::nv_coverage_reduction_mode::NV_COVERAGE_REDUCTION_MODE_EXTENSION_NAME),
            ext_tooling_info: available_device_extension(crate::extensions::ext_tooling_info::EXT_TOOLING_INFO_EXTENSION_NAME),
            khr_fragment_shading_rate: available_device_extension(crate::extensions::khr_fragment_shading_rate::KHR_FRAGMENT_SHADING_RATE_EXTENSION_NAME),
            khr_get_physical_device_properties2: enabled_extension(crate::extensions::khr_get_physical_device_properties2::KHR_GET_PHYSICAL_DEVICE_PROPERTIES_2_EXTENSION_NAME),
            khr_external_memory_capabilities: enabled_extension(crate::extensions::khr_external_memory_capabilities::KHR_EXTERNAL_MEMORY_CAPABILITIES_EXTENSION_NAME),
            khr_external_semaphore_capabilities: enabled_extension(crate::extensions::khr_external_semaphore_capabilities::KHR_EXTERNAL_SEMAPHORE_CAPABILITIES_EXTENSION_NAME),
            khr_external_fence_capabilities: enabled_extension(crate::extensions::khr_external_fence_capabilities::KHR_EXTERNAL_FENCE_CAPABILITIES_EXTENSION_NAME),
            khr_device_group_creation: enabled_extension(crate::extensions::khr_device_group_creation::KHR_DEVICE_GROUP_CREATION_EXTENSION_NAME),
        })
    }
}
...
impl DeviceEnabled {
    pub unsafe fn new(enabled_extensions: &[&std::ffi::CStr]) -> DeviceEnabled {
        let enabled_extension = |extension| enabled_extensions.contains(&std::ffi::CStr::from_ptr(extension));
        DeviceEnabled {
            ext_conditional_rendering: enabled_extension(crate::extensions::ext_conditional_rendering::EXT_CONDITIONAL_RENDERING_EXTENSION_NAME),
            khr_display_swapchain: enabled_extension(crate::extensions::khr_display_swapchain::KHR_DISPLAY_SWAPCHAIN_EXTENSION_NAME),
            khr_swapchain: enabled_extension(crate::extensions::khr_swapchain::KHR_SWAPCHAIN_EXTENSION_NAME),
            ext_debug_marker: enabled_extension(crate::extensions::ext_debug_marker::EXT_DEBUG_MARKER_EXTENSION_NAME),
            nv_external_memory_win32: enabled_extension(crate::extensions::nv_external_memory_win32::NV_EXTERNAL_MEMORY_WIN32_EXTENSION_NAME),
            nv_device_generated_commands: enabled_extension(crate::extensions::nv_device_generated_commands::NV_DEVICE_GENERATED_COMMANDS_EXTENSION_NAME),
            ...
            ext_display_control: enabled_extension(crate::extensions::ext_display_control::EXT_DISPLAY_CONTROL_EXTENSION_NAME),
            ext_hdr_metadata: enabled_extension(crate::extensions::ext_hdr_metadata::EXT_HDR_METADATA_EXTENSION_NAME),
            khr_shared_presentable_image: enabled_extension(crate::extensions::khr_shared_presentable_image::KHR_SHARED_PRESENTABLE_IMAGE_EXTENSION_NAME),
            google_display_timing: enabled_extension(crate::extensions::google_display_timing::GOOGLE_DISPLAY_TIMING_EXTENSION_NAME),
            nv_clip_space_w_scaling: enabled_extension(crate::extensions::nv_clip_space_w_scaling::NV_CLIP_SPACE_W_SCALING_EXTENSION_NAME),
            ext_discard_rectangles: enabled_extension(crate::extensions::ext_discard_rectangles::EXT_DISCARD_RECTANGLES_EXTENSION_NAME),
            ext_sample_locations: enabled_extension(crate::extensions::ext_sample_locations::EXT_SAMPLE_LOCATIONS_EXTENSION_NAME),
            ext_validation_cache: enabled_extension(crate::extensions::ext_validation_cache::EXT_VALIDATION_CACHE_EXTENSION_NAME),
            amd_shader_info: enabled_extension(crate::extensions::amd_shader_info::AMD_SHADER_INFO_EXTENSION_NAME),
            amd_display_native_hdr: enabled_extension(crate::extensions::amd_display_native_hdr::AMD_DISPLAY_NATIVE_HDR_EXTENSION_NAME),
            ...
            nv_shading_rate_image: enabled_extension(crate::extensions::nv_shading_rate_image::NV_SHADING_RATE_IMAGE_EXTENSION_NAME),
            nv_mesh_shader: enabled_extension(crate::extensions::nv_mesh_shader::NV_MESH_SHADER_EXTENSION_NAME),
            nv_ray_tracing: enabled_extension(crate::extensions::nv_ray_tracing::NV_RAY_TRACING_EXTENSION_NAME),
            khr_acceleration_structure: enabled_extension(crate::extensions::khr_acceleration_structure::KHR_ACCELERATION_STRUCTURE_EXTENSION_NAME),
            khr_ray_tracing_pipeline: enabled_extension(crate::extensions::khr_ray_tracing_pipeline::KHR_RAY_TRACING_PIPELINE_EXTENSION_NAME),
            nv_cooperative_matrix: enabled_extension(crate::extensions::nv_cooperative_matrix::NV_COOPERATIVE_MATRIX_EXTENSION_NAME),
            nvx_image_view_handle: enabled_extension(crate::extensions::nvx_image_view_handle::NVX_IMAGE_VIEW_HANDLE_EXTENSION_NAME),
            ext_full_screen_exclusive: enabled_extension(crate::extensions::ext_full_screen_exclusive::EXT_FULL_SCREEN_EXCLUSIVE_EXTENSION_NAME),
            khr_performance_query: enabled_extension(crate::extensions::khr_performance_query::KHR_PERFORMANCE_QUERY_EXTENSION_NAME),
            ext_image_drm_format_modifier: enabled_extension(crate::extensions::ext_image_drm_format_modifier::EXT_IMAGE_DRM_FORMAT_MODIFIER_EXTENSION_NAME),
            nv_coverage_reduction_mode: enabled_extension(crate::extensions::nv_coverage_reduction_mode::NV_COVERAGE_REDUCTION_MODE_EXTENSION_NAME),
            intel_performance_query: enabled_extension(crate::extensions::intel_performance_query::INTEL_PERFORMANCE_QUERY_EXTENSION_NAME),
            khr_pipeline_executable_properties: enabled_extension(crate::extensions::khr_pipeline_executable_properties::KHR_PIPELINE_EXECUTABLE_PROPERTIES_EXTENSION_NAME),
            ext_line_rasterization: enabled_extension(crate::extensions::ext_line_rasterization::EXT_LINE_RASTERIZATION_EXTENSION_NAME),
            ext_tooling_info: enabled_extension(crate::extensions::ext_tooling_info::EXT_TOOLING_INFO_EXTENSION_NAME),
            khr_deferred_host_operations: enabled_extension(crate::extensions::khr_deferred_host_operations::KHR_DEFERRED_HOST_OPERATIONS_EXTENSION_NAME),
            ext_extended_dynamic_state: enabled_extension(crate::extensions::ext_extended_dynamic_state::EXT_EXTENDED_DYNAMIC_STATE_EXTENSION_NAME),
            ext_private_data: enabled_extension(crate::extensions::ext_private_data::EXT_PRIVATE_DATA_EXTENSION_NAME),
            khr_copy_commands2: enabled_extension(crate::extensions::khr_copy_commands2::KHR_COPY_COMMANDS_2_EXTENSION_NAME),
            khr_fragment_shading_rate: enabled_extension(crate::extensions::khr_fragment_shading_rate::KHR_FRAGMENT_SHADING_RATE_EXTENSION_NAME),
            nv_fragment_shading_rate_enums: enabled_extension(crate::extensions::nv_fragment_shading_rate_enums::NV_FRAGMENT_SHADING_RATE_ENUMS_EXTENSION_NAME),
            khr_synchronization2: enabled_extension(crate::extensions::khr_synchronization2::KHR_SYNCHRONIZATION_2_EXTENSION_NAME),
            ext_host_query_reset: enabled_extension(crate::extensions::ext_host_query_reset::EXT_HOST_QUERY_RESET_EXTENSION_NAME),
            khr_maintenance1: enabled_extension(crate::extensions::khr_maintenance1::KHR_MAINTENANCE1_EXTENSION_NAME),
            khr_device_group: enabled_extension(crate::extensions::khr_device_group::KHR_DEVICE_GROUP_EXTENSION_NAME),
            khr_bind_memory2: enabled_extension(crate::extensions::khr_bind_memory2::KHR_BIND_MEMORY_2_EXTENSION_NAME),
            khr_descriptor_update_template: enabled_extension(crate::extensions::khr_descriptor_update_template::KHR_DESCRIPTOR_UPDATE_TEMPLATE_EXTENSION_NAME),
            khr_get_memory_requirements2: enabled_extension(crate::extensions::khr_get_memory_requirements2::KHR_GET_MEMORY_REQUIREMENTS_2_EXTENSION_NAME),
            khr_sampler_ycbcr_conversion: enabled_extension(crate::extensions::khr_sampler_ycbcr_conversion::KHR_SAMPLER_YCBCR_CONVERSION_EXTENSION_NAME),
            khr_maintenance3: enabled_extension(crate::extensions::khr_maintenance3::KHR_MAINTENANCE3_EXTENSION_NAME),
            khr_create_renderpass2: enabled_extension(crate::extensions::khr_create_renderpass2::KHR_CREATE_RENDERPASS_2_EXTENSION_NAME),
            khr_timeline_semaphore: enabled_extension(crate::extensions::khr_timeline_semaphore::KHR_TIMELINE_SEMAPHORE_EXTENSION_NAME),
            khr_draw_indirect_count: enabled_extension(crate::extensions::khr_draw_indirect_count::KHR_DRAW_INDIRECT_COUNT_EXTENSION_NAME),
            amd_draw_indirect_count: enabled_extension(crate::extensions::amd_draw_indirect_count::AMD_DRAW_INDIRECT_COUNT_EXTENSION_NAME),
            khr_buffer_device_address: enabled_extension(crate::extensions::khr_buffer_device_address::KHR_BUFFER_DEVICE_ADDRESS_EXTENSION_NAME),
            ext_buffer_device_address: enabled_extension(crate::extensions::ext_buffer_device_address::EXT_BUFFER_DEVICE_ADDRESS_EXTENSION_NAME),
        }
    }
}
