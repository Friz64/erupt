    ...
    pub unsafe fn custom(
        ...
        Ok(DeviceLoader {
            ...
            queue_submit2_khr: if device_enabled.khr_synchronization2 {
                std::mem::transmute(symbol(
                    crate::extensions::khr_synchronization2::FN_QUEUE_SUBMIT2_KHR,
                ))
            } else {
                None
            },
