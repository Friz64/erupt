...
impl DeviceLoader {
    ...
    #[inline]
    #[must_use = "Loading may have not been successful"]
    pub fn load_ext_private_data(&mut self) -> Option<()> {
        self.ext_private_data =
            crate::extensions::ext_private_data::ExtPrivateDataDeviceCommands::load(&self);
        self.ext_private_data.as_ref().map(|_| ())
    }
    #[inline]
    #[must_use = "Loading may have not been successful"]
