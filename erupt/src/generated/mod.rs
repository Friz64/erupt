...
impl InstanceEnabled {
    pub(crate) unsafe fn new(instance_version: u32, enabled_extensions: &[&std::ffi::CStr], available_device_extensions: &[&std::ffi::CStr]) -> Result<InstanceEnabled, crate::LoaderError> {
        ...
        Ok(InstanceEnabled {
            ...
            khr_video_queue: available_device_extension(crate::extensions::khr_video_queue::KHR_VIDEO_QUEUE_EXTENSION_NAME),
            ext_acquire_drm_display: enabled_extension(crate::extensions::ext_acquire_drm_display::EXT_ACQUIRE_DRM_DISPLAY_EXTENSION_NAME),
...
pub struct InstanceLoader {
    ...
    pub acquire_drm_display_ext: Option<extensions::ext_acquire_drm_display::PFN_vkAcquireDrmDisplayEXT>,
    pub get_drm_display_ext: Option<extensions::ext_acquire_drm_display::PFN_vkGetDrmDisplayEXT>,
...
impl InstanceLoader {
    ...
    pub(crate) unsafe fn custom<T>(entry_loader: &CustomEntryLoader<T>, instance: crate::vk1_0::Instance, instance_enabled: InstanceEnabled, mut symbol: impl FnMut(*const std::os::raw::c_char) -> Option<crate::vk1_0::PFN_vkVoidFunction>) -> Result<InstanceLoader, crate::LoaderError> {
        ...
        Ok(InstanceLoader {
            ...
            acquire_drm_display_ext: if instance_enabled.ext_acquire_drm_display { std::mem::transmute(symbol(crate::extensions::ext_acquire_drm_display::FN_ACQUIRE_DRM_DISPLAY_EXT)) } else { None },
            get_drm_display_ext: if instance_enabled.ext_acquire_drm_display { std::mem::transmute(symbol(crate::extensions::ext_acquire_drm_display::FN_GET_DRM_DISPLAY_EXT)) } else { None },
...
impl DeviceEnabled {
    pub(crate) unsafe fn new(enabled_extensions: &[&std::ffi::CStr]) -> DeviceEnabled {
        ...
        DeviceEnabled {
            ...
            ext_multi_draw: enabled_extension(crate::extensions::ext_multi_draw::EXT_MULTI_DRAW_EXTENSION_NAME),
            ...
            nv_external_memory_rdma: enabled_extension(crate::extensions::nv_external_memory_rdma::NV_EXTERNAL_MEMORY_RDMA_EXTENSION_NAME),
            ...
            khr_maintenance4: enabled_extension(crate::extensions::khr_maintenance4::KHR_MAINTENANCE_4_EXTENSION_NAME),
            ...
            huawei_invocation_mask: enabled_extension(crate::extensions::huawei_invocation_mask::HUAWEI_INVOCATION_MASK_EXTENSION_NAME),
            ...
            ext_extended_dynamic_state2: enabled_extension(crate::extensions::ext_extended_dynamic_state2::EXT_EXTENDED_DYNAMIC_STATE_2_EXTENSION_NAME),
            ...
            ext_vertex_input_dynamic_state: enabled_extension(crate::extensions::ext_vertex_input_dynamic_state::EXT_VERTEX_INPUT_DYNAMIC_STATE_EXTENSION_NAME),
            ext_color_write_enable: enabled_extension(crate::extensions::ext_color_write_enable::EXT_COLOR_WRITE_ENABLE_EXTENSION_NAME),
            khr_synchronization2: enabled_extension(crate::extensions::khr_synchronization2::KHR_SYNCHRONIZATION_2_EXTENSION_NAME),
            khr_video_queue: enabled_extension(crate::extensions::khr_video_queue::KHR_VIDEO_QUEUE_EXTENSION_NAME),
            khr_video_decode_queue: enabled_extension(crate::extensions::khr_video_decode_queue::KHR_VIDEO_DECODE_QUEUE_EXTENSION_NAME),
            khr_video_encode_queue: enabled_extension(crate::extensions::khr_video_encode_queue::KHR_VIDEO_ENCODE_QUEUE_EXTENSION_NAME),
            nvx_binary_import: enabled_extension(crate::extensions::nvx_binary_import::NVX_BINARY_IMPORT_EXTENSION_NAME),
            ext_pageable_device_local_memory: enabled_extension(crate::extensions::ext_pageable_device_local_memory::EXT_PAGEABLE_DEVICE_LOCAL_MEMORY_EXTENSION_NAME),
            khr_present_wait: enabled_extension(crate::extensions::khr_present_wait::KHR_PRESENT_WAIT_EXTENSION_NAME),
            fuchsia_buffer_collection: enabled_extension(crate::extensions::fuchsia_buffer_collection::FUCHSIA_BUFFER_COLLECTION_EXTENSION_NAME),
            khr_dynamic_rendering: enabled_extension(crate::extensions::khr_dynamic_rendering::KHR_DYNAMIC_RENDERING_EXTENSION_NAME),
            ext_host_query_reset: enabled_extension(crate::extensions::ext_host_query_reset::EXT_HOST_QUERY_RESET_EXTENSION_NAME),
            khr_maintenance1: enabled_extension(crate::extensions::khr_maintenance1::KHR_MAINTENANCE_1_EXTENSION_NAME),
            ...
            khr_maintenance3: enabled_extension(crate::extensions::khr_maintenance3::KHR_MAINTENANCE_3_EXTENSION_NAME),
...
pub struct DeviceLoader {
    ...
    pub get_device_subpass_shading_max_workgroup_size_huawei: Option<extensions::huawei_subpass_shading::PFN_vkGetDeviceSubpassShadingMaxWorkgroupSizeHUAWEI>,
    ...
    pub cmd_draw_multi_indexed_ext: Option<extensions::ext_multi_draw::PFN_vkCmdDrawMultiIndexedEXT>,
    ...
    pub cmd_subpass_shading_huawei: Option<extensions::huawei_subpass_shading::PFN_vkCmdSubpassShadingHUAWEI>,
    ...
    pub get_memory_remote_address_nv: Option<extensions::nv_external_memory_rdma::PFN_vkGetMemoryRemoteAddressNV>,
    ...
    pub get_device_buffer_memory_requirements_khr: Option<extensions::khr_maintenance4::PFN_vkGetDeviceBufferMemoryRequirementsKHR>,
    pub get_device_image_memory_requirements_khr: Option<extensions::khr_maintenance4::PFN_vkGetDeviceImageMemoryRequirementsKHR>,
    pub get_device_image_sparse_memory_requirements_khr: Option<extensions::khr_maintenance4::PFN_vkGetDeviceImageSparseMemoryRequirementsKHR>,
    ...
    pub cmd_bind_invocation_mask_huawei: Option<extensions::huawei_invocation_mask::PFN_vkCmdBindInvocationMaskHUAWEI>,
    ...
    pub set_device_memory_priority_ext: Option<extensions::ext_pageable_device_local_memory::PFN_vkSetDeviceMemoryPriorityEXT>,
    pub wait_for_present_khr: Option<extensions::khr_present_wait::PFN_vkWaitForPresentKHR>,
    pub create_buffer_collection_fuchsia: Option<extensions::fuchsia_buffer_collection::PFN_vkCreateBufferCollectionFUCHSIA>,
    pub set_buffer_collection_buffer_constraints_fuchsia: Option<extensions::fuchsia_buffer_collection::PFN_vkSetBufferCollectionBufferConstraintsFUCHSIA>,
    pub set_buffer_collection_image_constraints_fuchsia: Option<extensions::fuchsia_buffer_collection::PFN_vkSetBufferCollectionImageConstraintsFUCHSIA>,
    pub destroy_buffer_collection_fuchsia: Option<extensions::fuchsia_buffer_collection::PFN_vkDestroyBufferCollectionFUCHSIA>,
    pub get_buffer_collection_properties_fuchsia: Option<extensions::fuchsia_buffer_collection::PFN_vkGetBufferCollectionPropertiesFUCHSIA>,
    pub cmd_begin_rendering_khr: Option<extensions::khr_dynamic_rendering::PFN_vkCmdBeginRenderingKHR>,
    pub cmd_end_rendering_khr: Option<extensions::khr_dynamic_rendering::PFN_vkCmdEndRenderingKHR>,
...
impl DeviceLoader {
    ...
    pub(crate) unsafe fn custom(instance_loader: &InstanceLoader, device: crate::vk1_0::Device, device_enabled: DeviceEnabled, mut symbol: impl FnMut(*const std::os::raw::c_char) -> Option<crate::vk1_0::PFN_vkVoidFunction>) -> Result<DeviceLoader, crate::LoaderError> {
        ...
        Ok(DeviceLoader {
            ...
            get_device_subpass_shading_max_workgroup_size_huawei: if device_enabled.huawei_subpass_shading { std::mem::transmute(symbol(crate::extensions::huawei_subpass_shading::FN_GET_DEVICE_SUBPASS_SHADING_MAX_WORKGROUP_SIZE_HUAWEI)) } else { None },
            ...
            cmd_draw_multi_ext: if device_enabled.ext_multi_draw { std::mem::transmute(symbol(crate::extensions::ext_multi_draw::FN_CMD_DRAW_MULTI_EXT)) } else { None },
            cmd_draw_multi_indexed_ext: if device_enabled.ext_multi_draw { std::mem::transmute(symbol(crate::extensions::ext_multi_draw::FN_CMD_DRAW_MULTI_INDEXED_EXT)) } else { None },
            ...
            cmd_subpass_shading_huawei: if device_enabled.huawei_subpass_shading { std::mem::transmute(symbol(crate::extensions::huawei_subpass_shading::FN_CMD_SUBPASS_SHADING_HUAWEI)) } else { None },
            ...
            get_memory_remote_address_nv: if device_enabled.nv_external_memory_rdma { std::mem::transmute(symbol(crate::extensions::nv_external_memory_rdma::FN_GET_MEMORY_REMOTE_ADDRESS_NV)) } else { None },
            ...
            get_device_buffer_memory_requirements_khr: if device_enabled.khr_maintenance4 { std::mem::transmute(symbol(crate::extensions::khr_maintenance4::FN_GET_DEVICE_BUFFER_MEMORY_REQUIREMENTS_KHR)) } else { None },
            get_device_image_memory_requirements_khr: if device_enabled.khr_maintenance4 { std::mem::transmute(symbol(crate::extensions::khr_maintenance4::FN_GET_DEVICE_IMAGE_MEMORY_REQUIREMENTS_KHR)) } else { None },
            get_device_image_sparse_memory_requirements_khr: if device_enabled.khr_maintenance4 { std::mem::transmute(symbol(crate::extensions::khr_maintenance4::FN_GET_DEVICE_IMAGE_SPARSE_MEMORY_REQUIREMENTS_KHR)) } else { None },
            ...
            cmd_bind_invocation_mask_huawei: if device_enabled.huawei_invocation_mask { std::mem::transmute(symbol(crate::extensions::huawei_invocation_mask::FN_CMD_BIND_INVOCATION_MASK_HUAWEI)) } else { None },
            ...
            set_device_memory_priority_ext: if device_enabled.ext_pageable_device_local_memory { std::mem::transmute(symbol(crate::extensions::ext_pageable_device_local_memory::FN_SET_DEVICE_MEMORY_PRIORITY_EXT)) } else { None },
            wait_for_present_khr: if device_enabled.khr_present_wait { std::mem::transmute(symbol(crate::extensions::khr_present_wait::FN_WAIT_FOR_PRESENT_KHR)) } else { None },
            create_buffer_collection_fuchsia: if device_enabled.fuchsia_buffer_collection { std::mem::transmute(symbol(crate::extensions::fuchsia_buffer_collection::FN_CREATE_BUFFER_COLLECTION_FUCHSIA)) } else { None },
            set_buffer_collection_buffer_constraints_fuchsia: if device_enabled.fuchsia_buffer_collection { std::mem::transmute(symbol(crate::extensions::fuchsia_buffer_collection::FN_SET_BUFFER_COLLECTION_BUFFER_CONSTRAINTS_FUCHSIA)) } else { None },
            set_buffer_collection_image_constraints_fuchsia: if device_enabled.fuchsia_buffer_collection { std::mem::transmute(symbol(crate::extensions::fuchsia_buffer_collection::FN_SET_BUFFER_COLLECTION_IMAGE_CONSTRAINTS_FUCHSIA)) } else { None },
            destroy_buffer_collection_fuchsia: if device_enabled.fuchsia_buffer_collection { std::mem::transmute(symbol(crate::extensions::fuchsia_buffer_collection::FN_DESTROY_BUFFER_COLLECTION_FUCHSIA)) } else { None },
            get_buffer_collection_properties_fuchsia: if device_enabled.fuchsia_buffer_collection { std::mem::transmute(symbol(crate::extensions::fuchsia_buffer_collection::FN_GET_BUFFER_COLLECTION_PROPERTIES_FUCHSIA)) } else { None },
            cmd_begin_rendering_khr: if device_enabled.khr_dynamic_rendering { std::mem::transmute(symbol(crate::extensions::khr_dynamic_rendering::FN_CMD_BEGIN_RENDERING_KHR)) } else { None },
            cmd_end_rendering_khr: if device_enabled.khr_dynamic_rendering { std::mem::transmute(symbol(crate::extensions::khr_dynamic_rendering::FN_CMD_END_RENDERING_KHR)) } else { None },
