...
impl std::fmt::Debug for StructureType {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.write_str(match self {
            ...
            &Self::VIDEO_ENCODE_H264_RATE_CONTROL_INFO_EXT => "VIDEO_ENCODE_H264_RATE_CONTROL_INFO_EXT",
            &Self::VIDEO_ENCODE_H264_RATE_CONTROL_LAYER_INFO_EXT => "VIDEO_ENCODE_H264_RATE_CONTROL_LAYER_INFO_EXT",
            &Self::VIDEO_ENCODE_H265_CAPABILITIES_EXT => "VIDEO_ENCODE_H265_CAPABILITIES_EXT",
            &Self::VIDEO_ENCODE_H265_SESSION_CREATE_INFO_EXT => "VIDEO_ENCODE_H265_SESSION_CREATE_INFO_EXT",
            &Self::VIDEO_ENCODE_H265_SESSION_PARAMETERS_CREATE_INFO_EXT => "VIDEO_ENCODE_H265_SESSION_PARAMETERS_CREATE_INFO_EXT",
            &Self::VIDEO_ENCODE_H265_SESSION_PARAMETERS_ADD_INFO_EXT => "VIDEO_ENCODE_H265_SESSION_PARAMETERS_ADD_INFO_EXT",
            &Self::VIDEO_ENCODE_H265_VCL_FRAME_INFO_EXT => "VIDEO_ENCODE_H265_VCL_FRAME_INFO_EXT",
            &Self::VIDEO_ENCODE_H265_DPB_SLOT_INFO_EXT => "VIDEO_ENCODE_H265_DPB_SLOT_INFO_EXT",
            &Self::VIDEO_ENCODE_H265_NALU_SLICE_EXT => "VIDEO_ENCODE_H265_NALU_SLICE_EXT",
            &Self::VIDEO_ENCODE_H265_EMIT_PICTURE_PARAMETERS_EXT => "VIDEO_ENCODE_H265_EMIT_PICTURE_PARAMETERS_EXT",
            &Self::VIDEO_ENCODE_H265_PROFILE_EXT => "VIDEO_ENCODE_H265_PROFILE_EXT",
            &Self::VIDEO_ENCODE_H265_REFERENCE_LISTS_EXT => "VIDEO_ENCODE_H265_REFERENCE_LISTS_EXT",
            &Self::VIDEO_ENCODE_H265_RATE_CONTROL_INFO_EXT => "VIDEO_ENCODE_H265_RATE_CONTROL_INFO_EXT",
            &Self::VIDEO_ENCODE_H265_RATE_CONTROL_LAYER_INFO_EXT => "VIDEO_ENCODE_H265_RATE_CONTROL_LAYER_INFO_EXT",
            ...
            &Self::ANDROID_HARDWARE_BUFFER_FORMAT_PROPERTIES_2_ANDROID => "ANDROID_HARDWARE_BUFFER_FORMAT_PROPERTIES_2_ANDROID",
            ...
            &Self::DRM_FORMAT_MODIFIER_PROPERTIES_LIST_2_EXT => "DRM_FORMAT_MODIFIER_PROPERTIES_LIST_2_EXT",
            ...
            &Self::VIDEO_ENCODE_RATE_CONTROL_LAYER_INFO_KHR => "VIDEO_ENCODE_RATE_CONTROL_LAYER_INFO_KHR",
            ...
            &Self::BUFFER_COLLECTION_CREATE_INFO_FUCHSIA => "BUFFER_COLLECTION_CREATE_INFO_FUCHSIA",
            &Self::IMPORT_MEMORY_BUFFER_COLLECTION_FUCHSIA => "IMPORT_MEMORY_BUFFER_COLLECTION_FUCHSIA",
            &Self::BUFFER_COLLECTION_IMAGE_CREATE_INFO_FUCHSIA => "BUFFER_COLLECTION_IMAGE_CREATE_INFO_FUCHSIA",
            &Self::BUFFER_COLLECTION_PROPERTIES_FUCHSIA => "BUFFER_COLLECTION_PROPERTIES_FUCHSIA",
            &Self::BUFFER_CONSTRAINTS_INFO_FUCHSIA => "BUFFER_CONSTRAINTS_INFO_FUCHSIA",
            &Self::BUFFER_COLLECTION_BUFFER_CREATE_INFO_FUCHSIA => "BUFFER_COLLECTION_BUFFER_CREATE_INFO_FUCHSIA",
            &Self::IMAGE_CONSTRAINTS_INFO_FUCHSIA => "IMAGE_CONSTRAINTS_INFO_FUCHSIA",
            &Self::IMAGE_FORMAT_CONSTRAINTS_INFO_FUCHSIA => "IMAGE_FORMAT_CONSTRAINTS_INFO_FUCHSIA",
            &Self::SYSMEM_COLOR_SPACE_FUCHSIA => "SYSMEM_COLOR_SPACE_FUCHSIA",
            &Self::BUFFER_COLLECTION_CONSTRAINTS_INFO_FUCHSIA => "BUFFER_COLLECTION_CONSTRAINTS_INFO_FUCHSIA",
            ...
            &Self::SAMPLER_BORDER_COLOR_COMPONENT_MAPPING_CREATE_INFO_EXT => "SAMPLER_BORDER_COLOR_COMPONENT_MAPPING_CREATE_INFO_EXT",
            &Self::PHYSICAL_DEVICE_PAGEABLE_DEVICE_LOCAL_MEMORY_FEATURES_EXT => "PHYSICAL_DEVICE_PAGEABLE_DEVICE_LOCAL_MEMORY_FEATURES_EXT",
            &Self::PHYSICAL_DEVICE_MAINTENANCE_4_FEATURES_KHR => "PHYSICAL_DEVICE_MAINTENANCE_4_FEATURES_KHR",
